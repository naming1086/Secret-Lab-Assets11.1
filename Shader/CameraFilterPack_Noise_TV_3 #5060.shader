...
void main()
{
    ...
    u_xlat9 = u_xlat1.x * _Value3;
    u_xlat0.x = u_xlat9 * 0.03125 + u_xlat0.y;
    u_xlat0 = texture(_MainTex, u_xlat0.xz);
    u_xlat2 = (-u_xlat0) + u_xlat1;
    u_xlat0 = vec4(vec4(_Value, _Value, _Value, _Value)) * u_xlat2 + u_xlat0;
    SV_Target0 = vec4(vec4(_Value2, _Value2, _Value2, _Value2)) * u_xlat1 + u_xlat0;
    return;
}
        ...
        UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                    UniformConstant sampler* %78 = OpVariable UniformConstant 
                              ...
                              Uniform f32_4* %24 = OpAccessChain %16 %18 
                                ...
                                Uniform f32* %33 = OpAccessChain %16 %31 
                                       ...
                                       f32_4 %40 = OpLoad %9 
                                       f32_2 %41 = OpVectorShuffle %40 %40 1 2 
                                       f32_2 %42 = OpFAdd %39 %41 
                                       f32_4 %43 = OpLoad %30 
                  ...
                  read_only Texture2DSampled %54 = OpSampledImage %48 %52 
                                       ...
                                       f32_4 %57 = OpImageSampleImplicitLod %54 %56 
                                                     OpStore %30 %57 
                                Private f32* %62 = OpAccessChain %30 %61 
                                         f32 %63 = OpLoad %62 
                                ...
                                Private f32* %72 = OpAccessChain %9 %71 
                                         f32 %73 = OpLoad %72 
                                         f32 %74 = OpFAdd %70 %73 
                                Private f32* %75 = OpAccessChain %9 %61 
                                                     OpStore %75 %74 
