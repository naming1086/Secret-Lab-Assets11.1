...
#endif
uniform 	vec4 _Color;
UNITY_LOCATION(0) uniform  sampler2D _DepthTex;
...
void main()
{
    ...
    u_xlat0 = texture(_DepthTex, vs_TEXCOORD0.xy);
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %22 %26 %50 
...
UniformConstant read_only Texture2D* %37 = OpVariable UniformConstant 
            UniformConstant sampler* %39 = OpVariable UniformConstant 
                         ...
                         Output f32* %50 = OpVariable Output 
                                 void %4 = OpFunction None %3 
                                      %5 = OpLabel 
          ...
          read_only Texture2DSampled %41 = OpSampledImage %38 %40 
                               f32_2 %42 = OpLoad vs_TEXCOORD0 
                               f32_4 %43 = OpImageSampleImplicitLod %41 %42 
                                 f32 %46 = OpCompositeExtract %43 0 
                        Private f32* %48 = OpAccessChain %9 %45 
                                             OpStore %48 %46 
                        Private f32* %51 = OpAccessChain %9 %45 
                                 f32 %52 = OpLoad %51 
                                             OpStore %50 %52 
                                             OpReturn
                                             OpFunctionEnd
