...
; Schema: 0
                                           ...
                                           %1 = OpExtInstImport "GLSL.std.450" 
                                                  OpMemoryModel Logical GLSL450 
                                                  OpEntryPoint Fragment %4 "main" %28 %196 
     ...
     UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                 UniformConstant sampler* %78 = OpVariable UniformConstant 
                         ...
                         Private bool_3* %142 = OpVariable Private 
                                   ...
                                   f32_4 %146 = OpConstantComposite %145 %145 %145 %22 
                                         %147 = OpTypeVector %6 4 
                                         %150 = OpTypePointer Function %24 
                                     u32 %153 = OpConstant 0 
                                         %195 = OpTypePointer Output %11 
                           Output f32_4* %196 = OpVariable Output 
                                     i32 %197 = OpConstant 0 
                                     u32 %215 = OpConstant 3 
                                         %216 = OpTypePointer Output %9 
                                      void %4 = OpFunction None %3 
                                           %5 = OpLabel 
               ...
               read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                            ...
                            Uniform f32* %106 = OpAccessChain %14 %90 
                                   ...
                                   f32_3 %127 = OpFDiv %125 %126 
                                                  OpStore %26 %127 
                                   f32_3 %128 = OpLoad %26 
                                   f32_3 %129 = OpFNegate %128 
                                   f32_3 %130 = OpFAdd %129 %119 
                                                  OpStore %26 %130 
                                   f32_3 %131 = OpLoad %61 
                                   f32_3 %132 = OpFNegate %131 
                                   f32_3 %133 = OpFAdd %132 %119 
                                                  OpStore %121 %133 
                                   f32_3 %134 = OpLoad %121 
                                   f32_3 %135 = OpLoad %121 
                                   f32_3 %136 = OpFAdd %134 %135 
                                                  OpStore %121 %136 
                                   f32_3 %137 = OpLoad %95 
                                   f32_3 %138 = OpLoad %121 
                                   f32_3 %139 = OpFDiv %137 %138 
                                                  OpStore %95 %139 
                                   f32_3 %143 = OpLoad %61 
                                   f32_4 %144 = OpVectorShuffle %143 %143 0 1 2 0 
                                  bool_4 %148 = OpFOrdLessThan %144 %146 
                                  bool_3 %149 = OpVectorShuffle %148 %148 0 1 2 
                                                  OpStore %142 %149 
                                   f32_3 %152 = OpLoad %26 
                                                  OpStore %151 %152 
                           Private bool* %154 = OpAccessChain %142 %153 
                                    bool %155 = OpLoad %154 
                                                  OpSelectionMerge %158 None 
                                                  OpBranchConditional %155 %157 %161 
                                         %157 = OpLabel 
                            Private f32* %159 = OpAccessChain %26 %153 
                                     f32 %160 = OpLoad %159 
                                                  OpStore %156 %160 
                                                  OpBranch %158 
                                         %161 = OpLabel 
                            Private f32* %162 = OpAccessChain %95 %153 
                                     f32 %163 = OpLoad %162 
                                                  OpStore %156 %163 
                                                  OpBranch %158 
                                         %158 = OpLabel 
                                     f32 %164 = OpLoad %156 
                           Function f32* %165 = OpAccessChain %151 %153 
                                                  OpStore %165 %164 
                           Private bool* %166 = OpAccessChain %142 %18 
                                    bool %167 = OpLoad %166 
                                                  OpSelectionMerge %170 None 
                                                  OpBranchConditional %167 %169 %173 
                                         %169 = OpLabel 
                            Private f32* %171 = OpAccessChain %26 %18 
                                     f32 %172 = OpLoad %171 
                                                  OpStore %168 %172 
                                                  OpBranch %170 
                                         %173 = OpLabel 
                            Private f32* %174 = OpAccessChain %95 %18 
                                     f32 %175 = OpLoad %174 
                                                  OpStore %168 %175 
                                                  OpBranch %170 
                                         %170 = OpLabel 
                                     f32 %176 = OpLoad %168 
                           Function f32* %177 = OpAccessChain %151 %18 
                                                  OpStore %177 %176 
                           Private bool* %178 = OpAccessChain %142 %59 
                                    bool %179 = OpLoad %178 
                            ...
                            Private f32* %183 = OpAccessChain %26 %59 
                                     f32 %184 = OpLoad %183 
                                                  ...
                                                  OpBranch %182 
                                         %185 = OpLabel 
                            Private f32* %186 = OpAccessChain %95 %59 
                                     f32 %187 = OpLoad %186 
                                                  OpStore %180 %187 
                                                  OpBranch %182 
                                         %182 = OpLabel 
                                     f32 %188 = OpLoad %180 
                           Function f32* %189 = OpAccessChain %151 %59 
                                                  OpStore %189 %188 
                                   f32_3 %190 = OpLoad %151 
                                                  OpStore %26 %190 
                                   f32_3 %191 = OpLoad %61 
                                   ...
                                   f32_3 %194 = OpFAdd %192 %193 
                                                  OpStore %26 %194 
                            Uniform f32* %198 = OpAccessChain %14 %197 
                                     f32 %199 = OpLoad %198 
                            Uniform f32* %200 = OpAccessChain %14 %197 
                                     f32 %201 = OpLoad %200 
                            Uniform f32* %202 = OpAccessChain %14 %197 
                                     f32 %203 = OpLoad %202 
                                   f32_3 %204 = OpCompositeConstruct %199 %201 %203 
                                     f32 %205 = OpCompositeExtract %204 0 
                                     f32 %206 = OpCompositeExtract %204 1 
                                     f32 %207 = OpCompositeExtract %204 2 
                                   f32_3 %208 = OpCompositeConstruct %205 %206 %207 
                                   f32_3 %209 = OpLoad %26 
                                   f32_3 %210 = OpFMul %208 %209 
                                   f32_3 %211 = OpLoad %61 
                                   f32_3 %212 = OpFAdd %210 %211 
                                   f32_4 %213 = OpLoad %196 
                                   f32_4 %214 = OpVectorShuffle %213 %212 4 5 6 3 
                                                  OpStore %196 %214 
                             Output f32* %217 = OpAccessChain %196 %215 
                                                  OpStore %217 %47 
                                                  OpReturn
                                                  OpFunctionEnd
"
