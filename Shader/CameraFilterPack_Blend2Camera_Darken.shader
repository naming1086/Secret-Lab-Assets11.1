...
; Schema: 0
                                           ...
                                           %1 = OpExtInstImport "GLSL.std.450" 
                                                  OpMemoryModel Logical GLSL450 
                                                  OpEntryPoint Fragment %4 "main" %28 %125 
     ...
     UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
               ...
               read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                            ...
                            Uniform f32* %106 = OpAccessChain %14 %90 
                                   ...
                                   f32_3 %117 = OpLoad %95 
                                   f32_3 %118 = OpLoad %61 
                                   f32_3 %119 = OpExtInst %1 37 %117 %118 
                                                  OpStore %26 %119 
                                   f32_3 %120 = OpLoad %61 
                                   ...
                                   f32_3 %123 = OpFAdd %121 %122 
                                                  OpStore %26 %123 
                            Uniform f32* %127 = OpAccessChain %14 %126 
                                     f32 %128 = OpLoad %127 
                            Uniform f32* %129 = OpAccessChain %14 %126 
                                     f32 %130 = OpLoad %129 
                            Uniform f32* %131 = OpAccessChain %14 %126 
                                     f32 %132 = OpLoad %131 
