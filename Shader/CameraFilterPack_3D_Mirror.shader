...
void main()
{
    ...
    u_xlat2 = vec4(Fade) * u_xlat2 + u_xlat1;
    u_xlat2 = u_xlat2 * vec4(vec4(Lightning, Lightning, Lightning, Lightning)) + (-u_xlat1);
        ...
        UniformConstant read_only Texture2D* %151 = OpVariable UniformConstant 
                  ...
                  read_only Texture2DSampled %168 = OpSampledImage %166 %167 
                                ...
                                Uniform f32* %192 = OpAccessChain %40 %185 
                                       ...
                                       f32_4 %200 = OpFMul %184 %199 
                                       f32_4 %201 = OpLoad %150 
