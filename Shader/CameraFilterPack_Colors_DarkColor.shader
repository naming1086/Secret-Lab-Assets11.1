...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %69 
...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Uniform f32* %72 = OpAccessChain %17 %70 
                                 f32 %73 = OpLoad %72 
                        Uniform f32* %74 = OpAccessChain %17 %70 
                                 f32 %75 = OpLoad %74 
                        Uniform f32* %76 = OpAccessChain %17 %70 
                                 f32 %77 = OpLoad %76 
                               ...
                               f32_4 %88 = OpVectorShuffle %87 %86 4 5 6 3 
                                             OpStore %69 %88 
                         Output f32* %92 = OpAccessChain %69 %90 
                                             OpStore %92 %89 
                                             OpReturn
                                             OpFunctionEnd
"
