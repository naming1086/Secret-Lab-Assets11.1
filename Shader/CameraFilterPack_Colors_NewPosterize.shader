   ...
   UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
             ...
             read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                           ...
                           Uniform f32* %50 = OpAccessChain %17 %48 
                                    f32 %51 = OpLoad %50 
                           Uniform f32* %52 = OpAccessChain %17 %48 
                                    f32 %53 = OpLoad %52 
                           Uniform f32* %54 = OpAccessChain %17 %48 
                                    f32 %55 = OpLoad %54 
                                  f32_3 %56 = OpCompositeConstruct %51 %53 %55 
                                    f32 %57 = OpCompositeExtract %56 0 
                                    f32 %58 = OpCompositeExtract %56 1 
                                    f32 %59 = OpCompositeExtract %56 2 
                                  f32_3 %60 = OpCompositeConstruct %57 %58 %59 
                                  f32_3 %61 = OpFMul %47 %60 
                                                OpStore %9 %61 
                                  f32_3 %62 = OpLoad %9 
                                  f32_3 %63 = OpExtInst %1 29 %62 
                                                OpStore %9 %63 
                                  f32_3 %64 = OpLoad %9 
                           Uniform f32* %66 = OpAccessChain %17 %65 
                                    f32 %67 = OpLoad %66 
                           Uniform f32* %68 = OpAccessChain %17 %65 
                                    f32 %69 = OpLoad %68 
                           Uniform f32* %70 = OpAccessChain %17 %65 
                                    f32 %71 = OpLoad %70 
                                  f32_3 %72 = OpCompositeConstruct %67 %69 %71 
                                    f32 %73 = OpCompositeExtract %72 0 
                                    f32 %74 = OpCompositeExtract %72 1 
                                    f32 %75 = OpCompositeExtract %72 2 
                                  f32_3 %76 = OpCompositeConstruct %73 %74 %75 
                                  f32_3 %77 = OpFMul %64 %76 
                                                OpStore %9 %77 
                                  f32_3 %78 = OpLoad %9 
                                  f32_3 %79 = OpExtInst %1 8 %78 
                                                OpStore %9 %79 
                                  f32_3 %80 = OpLoad %9 
                           Uniform f32* %81 = OpAccessChain %17 %65 
                                    f32 %82 = OpLoad %81 
                           Uniform f32* %83 = OpAccessChain %17 %65 
                                    f32 %84 = OpLoad %83 
                           Uniform f32* %85 = OpAccessChain %17 %65 
                                    f32 %86 = OpLoad %85 
                                  ...
                                  f32_3 %92 = OpFDiv %80 %91 
                                                OpStore %9 %92 
                                  f32_3 %93 = OpLoad %9 
                                  f32_3 %94 = OpExtInst %1 30 %93 
                                                OpStore %9 %94 
                           Uniform f32* %98 = OpAccessChain %17 %48 
                                    f32 %99 = OpLoad %98 
                                   f32 %100 = OpFDiv %97 %99 
                                                OpStore %96 %100 
                                 f32_3 %101 = OpLoad %9 
                                   f32 %102 = OpLoad %96 
                                 ...
                                 f32_3 %104 = OpFMul %101 %103 
                                                OpStore %9 %104 
                                 f32_3 %105 = OpLoad %9 
                                 f32_3 %106 = OpExtInst %1 29 %105 
                                                OpStore %9 %106 
                          Private f32* %111 = OpAccessChain %9 %110 
                                   f32 %112 = OpLoad %111 
                          Uniform f32* %114 = OpAccessChain %17 %113 
                                   f32 %115 = OpLoad %114 
                                   f32 %116 = OpFMul %112 %115 
                           Output f32* %118 = OpAccessChain %108 %110 
                                                OpStore %118 %116 
                                 f32_3 %119 = OpLoad %9 
                                 f32_2 %120 = OpVectorShuffle %119 %119 0 2 
                                 f32_2 %124 = OpFMul %120 %123 
                                 f32_4 %125 = OpLoad %108 
                                 f32_4 %126 = OpVectorShuffle %125 %124 4 1 5 3 
                                                OpStore %108 %126 
                           Output f32* %128 = OpAccessChain %108 %127 
                                                OpStore %128 %97 
                                                OpReturn
                                                OpFunctionEnd
"
