...
; Schema: 0
                                           ...
                                           %1 = OpExtInstImport "GLSL.std.450" 
                                                  OpMemoryModel Logical GLSL450 
                                                  OpEntryPoint Fragment %4 "main" %28 %131 
     ...
     UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                 UniformConstant sampler* %78 = OpVariable UniformConstant 
                           ...
                           Private f32_3* %95 = OpVariable Private 
                                         %130 = OpTypePointer Output %11 
                           Output f32_4* %131 = OpVariable Output 
                                     i32 %132 = OpConstant 0 
               ...
               read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                            ...
                            Uniform f32* %106 = OpAccessChain %14 %90 
                                   ...
                                   f32_3 %129 = OpFAdd %127 %128 
                                                  OpStore %26 %129 
                            Uniform f32* %133 = OpAccessChain %14 %132 
                                     f32 %134 = OpLoad %133 
                            Uniform f32* %135 = OpAccessChain %14 %132 
                                     f32 %136 = OpLoad %135 
                            Uniform f32* %137 = OpAccessChain %14 %132 
                                     f32 %138 = OpLoad %137 
                                   ...
                                   f32_4 %149 = OpVectorShuffle %148 %147 4 5 6 3 
                                                  OpStore %131 %149 
                             Output f32* %152 = OpAccessChain %131 %150 
                                                  OpStore %152 %47 
                                                  OpReturn
                                                  OpFunctionEnd
"
