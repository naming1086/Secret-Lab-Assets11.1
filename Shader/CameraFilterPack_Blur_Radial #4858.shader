   ...
   UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
               ...
               UniformConstant sampler* %37 = OpVariable UniformConstant 
                        ...
                        Private f32_4* %114 = OpVariable Private 
                                 ...
                                 f32_4 %169 = OpConstantComposite %165 %166 %167 %168 
                                 ...
                                 f32_4 %256 = OpConstantComposite %252 %253 %254 %255 
                                       %331 = OpTypeVector %6 3 
                                   f32 %337 = OpConstant 3.674022E-40 
                                   f32 %338 = OpConstant 3.674022E-40 
                                   f32 %339 = OpConstant 3.674022E-40 
                                 f32_3 %340 = OpConstantComposite %337 %338 %339 
                                 f32_3 %342 = OpConstantComposite %80 %80 %80 
                                       %401 = OpTypePointer Output %7 
                         Output f32_4* %402 = OpVariable Output 
                                   f32 %404 = OpConstant 3.674022E-40 
                                 f32_4 %405 = OpConstantComposite %404 %404 %404 %404 
                                    void %4 = OpFunction None %3 
                                         %5 = OpLabel 
            ...
            read_only Texture2DSampled %141 = OpSampledImage %139 %140 
                          ...
                          Uniform f32* %155 = OpAccessChain %16 %59 
                                   f32 %156 = OpLoad %155 
                          Uniform f32* %157 = OpAccessChain %16 %59 
                                   f32 %158 = OpLoad %157 
                                 f32_4 %159 = OpCompositeConstruct %152 %154 %156 %158 
                                   f32 %160 = OpCompositeExtract %159 0 
                                   f32 %161 = OpCompositeExtract %159 1 
                                   f32 %162 = OpCompositeExtract %159 2 
                                   f32 %163 = OpCompositeExtract %159 3 
                                 f32_4 %164 = OpCompositeConstruct %160 %161 %162 %163 
                                 f32_4 %170 = OpFMul %164 %169 
                                 f32_4 %171 = OpFAdd %170 %81 
                                                OpStore %58 %171 
                                 f32_4 %172 = OpLoad %9 
                          ...
                          Uniform f32* %183 = OpAccessChain %16 %50 
                                 ...
                                 f32_4 %189 = OpLoad %58 
                                 f32_4 %190 = OpVectorShuffle %189 %189 2 2 3 3 
                                 f32_4 %191 = OpFMul %188 %190 
                          Uniform f32* %192 = OpAccessChain %16 %46 
                                   f32 %193 = OpLoad %192 
                          Uniform f32* %194 = OpAccessChain %16 %50 
                                   f32 %195 = OpLoad %194 
                          Uniform f32* %196 = OpAccessChain %16 %46 
                                   f32 %197 = OpLoad %196 
                          Uniform f32* %198 = OpAccessChain %16 %50 
                                   f32 %199 = OpLoad %198 
                                 f32_4 %200 = OpCompositeConstruct %193 %195 %197 %199 
                                 f32_4 %201 = OpFAdd %191 %200 
                                                OpStore %58 %201 
                   read_only Texture2D %202 = OpLoad %33 
                               sampler %203 = OpLoad %37 
            ...
            read_only Texture2DSampled %210 = OpSampledImage %208 %209 
                                 ...
                                 f32_4 %219 = OpFAdd %217 %218 
                                                OpStore %30 %219 
                   read_only Texture2D %220 = OpLoad %33 
                               sampler %221 = OpLoad %37 
            read_only Texture2DSampled %222 = OpSampledImage %220 %221 
                                 ...
                                 f32_4 %225 = OpImageSampleImplicitLod %222 %224 
                                                OpStore %83 %225 
                   read_only Texture2D %226 = OpLoad %33 
                               sampler %227 = OpLoad %37 
            read_only Texture2DSampled %228 = OpSampledImage %226 %227 
                                 ...
                                 f32_4 %237 = OpFAdd %235 %236 
                                                OpStore %30 %237 
                          Uniform f32* %238 = OpAccessChain %16 %59 
                                   f32 %239 = OpLoad %238 
                          Uniform f32* %240 = OpAccessChain %16 %59 
                                   f32 %241 = OpLoad %240 
                          Uniform f32* %242 = OpAccessChain %16 %59 
                                   f32 %243 = OpLoad %242 
                          Uniform f32* %244 = OpAccessChain %16 %59 
                                   f32 %245 = OpLoad %244 
                                 f32_4 %246 = OpCompositeConstruct %239 %241 %243 %245 
                                   f32 %247 = OpCompositeExtract %246 0 
                                   f32 %248 = OpCompositeExtract %246 1 
                                   f32 %249 = OpCompositeExtract %246 2 
                                   f32 %250 = OpCompositeExtract %246 3 
                                 f32_4 %251 = OpCompositeConstruct %247 %248 %249 %250 
                                 f32_4 %257 = OpFMul %251 %256 
                                 f32_4 %258 = OpFAdd %257 %81 
                                                OpStore %58 %258 
                                 f32_4 %259 = OpLoad %9 
                                 f32_4 %260 = OpVectorShuffle %259 %259 0 1 0 1 
                                 f32_4 %261 = OpLoad %58 
                                 f32_4 %262 = OpVectorShuffle %261 %261 0 0 1 1 
                                 f32_4 %263 = OpFMul %260 %262 
                          Uniform f32* %264 = OpAccessChain %16 %46 
                                   f32 %265 = OpLoad %264 
                          Uniform f32* %266 = OpAccessChain %16 %50 
                                   f32 %267 = OpLoad %266 
                          Uniform f32* %268 = OpAccessChain %16 %46 
                                   f32 %269 = OpLoad %268 
                          Uniform f32* %270 = OpAccessChain %16 %50 
                                   f32 %271 = OpLoad %270 
                                 f32_4 %272 = OpCompositeConstruct %265 %267 %269 %271 
                                 f32_4 %273 = OpFAdd %263 %272 
                                                OpStore %83 %273 
                                 f32_4 %274 = OpLoad %9 
                                 f32_4 %275 = OpVectorShuffle %274 %274 0 1 0 1 
                                 f32_4 %276 = OpLoad %58 
                                 f32_4 %277 = OpVectorShuffle %276 %276 2 2 3 3 
                                 f32_4 %278 = OpFMul %275 %277 
                          Uniform f32* %279 = OpAccessChain %16 %46 
                                   f32 %280 = OpLoad %279 
                          Uniform f32* %281 = OpAccessChain %16 %50 
                                   f32 %282 = OpLoad %281 
                          Uniform f32* %283 = OpAccessChain %16 %46 
                                   f32 %284 = OpLoad %283 
                          Uniform f32* %285 = OpAccessChain %16 %50 
                                   f32 %286 = OpLoad %285 
                                 f32_4 %287 = OpCompositeConstruct %280 %282 %284 %286 
                                 f32_4 %288 = OpFAdd %278 %287 
                                                OpStore %58 %288 
                   read_only Texture2D %289 = OpLoad %33 
                               sampler %290 = OpLoad %37 
            read_only Texture2DSampled %291 = OpSampledImage %289 %290 
                                 f32_4 %292 = OpLoad %83 
                                 f32_2 %293 = OpVectorShuffle %292 %292 0 1 
                                 f32_4 %294 = OpImageSampleImplicitLod %291 %293 
                                                OpStore %114 %294 
                   read_only Texture2D %295 = OpLoad %33 
                               sampler %296 = OpLoad %37 
            read_only Texture2DSampled %297 = OpSampledImage %295 %296 
                                 f32_4 %298 = OpLoad %83 
                                 f32_2 %299 = OpVectorShuffle %298 %298 2 3 
                                 ...
                                 f32_4 %306 = OpFAdd %304 %305 
                                                OpStore %30 %306 
                   read_only Texture2D %307 = OpLoad %33 
                               sampler %308 = OpLoad %37 
            read_only Texture2DSampled %309 = OpSampledImage %307 %308 
                                 ...
                                 f32_4 %312 = OpImageSampleImplicitLod %309 %311 
                                                OpStore %83 %312 
                   read_only Texture2D %313 = OpLoad %33 
                               sampler %314 = OpLoad %37 
            read_only Texture2DSampled %315 = OpSampledImage %313 %314 
                                 ...
                                 f32_4 %324 = OpFAdd %322 %323 
                                                OpStore %30 %324 
                          Uniform f32* %325 = OpAccessChain %16 %59 
                                   f32 %326 = OpLoad %325 
                          Uniform f32* %327 = OpAccessChain %16 %59 
                                   f32 %328 = OpLoad %327 
                          Uniform f32* %329 = OpAccessChain %16 %59 
                                   f32 %330 = OpLoad %329 
                                 f32_3 %332 = OpCompositeConstruct %326 %328 %330 
                                   f32 %333 = OpCompositeExtract %332 0 
                                   f32 %334 = OpCompositeExtract %332 1 
                                   f32 %335 = OpCompositeExtract %332 2 
                                 f32_3 %336 = OpCompositeConstruct %333 %334 %335 
                                 ...
                                 f32_4 %345 = OpVectorShuffle %344 %343 4 5 6 3 
                                                OpStore %58 %345 
                                 f32_4 %346 = OpLoad %9 
                                 f32_4 %347 = OpVectorShuffle %346 %346 0 1 0 1 
                                 f32_4 %348 = OpLoad %58 
                                 f32_4 %349 = OpVectorShuffle %348 %348 0 0 1 1 
                                 f32_4 %350 = OpFMul %347 %349 
                          Uniform f32* %351 = OpAccessChain %16 %46 
                                   f32 %352 = OpLoad %351 
                          Uniform f32* %353 = OpAccessChain %16 %50 
                                   f32 %354 = OpLoad %353 
                          Uniform f32* %355 = OpAccessChain %16 %46 
                                   f32 %356 = OpLoad %355 
                          Uniform f32* %357 = OpAccessChain %16 %50 
                                   f32 %358 = OpLoad %357 
                                 f32_4 %359 = OpCompositeConstruct %352 %354 %356 %358 
                                 f32_4 %360 = OpFAdd %350 %359 
                                                OpStore %83 %360 
                                 f32_4 %361 = OpLoad %9 
                                 f32_2 %362 = OpVectorShuffle %361 %361 0 1 
                                 f32_4 %363 = OpLoad %58 
                                 f32_2 %364 = OpVectorShuffle %363 %363 2 2 
                                 f32_2 %365 = OpFMul %362 %364 
                          Uniform f32* %366 = OpAccessChain %16 %46 
                                   f32 %367 = OpLoad %366 
                          Uniform f32* %368 = OpAccessChain %16 %50 
                                   f32 %369 = OpLoad %368 
                                 f32_2 %370 = OpCompositeConstruct %367 %369 
                                 f32_2 %371 = OpFAdd %365 %370 
                                 f32_4 %372 = OpLoad %9 
                                 f32_4 %373 = OpVectorShuffle %372 %371 4 5 2 3 
                                                OpStore %9 %373 
                   read_only Texture2D %374 = OpLoad %33 
                               sampler %375 = OpLoad %37 
            read_only Texture2DSampled %376 = OpSampledImage %374 %375 
                                 ...
                                 f32_4 %379 = OpImageSampleImplicitLod %376 %378 
                                                OpStore %9 %379 
                   read_only Texture2D %380 = OpLoad %33 
                               sampler %381 = OpLoad %37 
            read_only Texture2DSampled %382 = OpSampledImage %380 %381 
                                 ...
                                 f32_4 %385 = OpImageSampleImplicitLod %382 %384 
                                                OpStore %58 %385 
                   read_only Texture2D %386 = OpLoad %33 
                               sampler %387 = OpLoad %37 
            read_only Texture2DSampled %388 = OpSampledImage %386 %387 
                                 f32_4 %389 = OpLoad %83 
                                 f32_2 %390 = OpVectorShuffle %389 %389 2 3 
