...
Uniform struct {f32; f32; f32_2; f32_4;}* %14 = OpVariable Uniform 
     ...
     UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                 UniformConstant sampler* %78 = OpVariable UniformConstant 
                         ...
                         Private bool_3* %140 = OpVariable Private 
                                     f32 %143 = OpConstant 3.674022E-40 
                                   f32_4 %144 = OpConstantComposite %143 %143 %143 %22 
                                         %145 = OpTypeVector %6 4 
                            ...
                            Uniform f32* %106 = OpAccessChain %14 %90 
                                   ...
                                   f32_2 %136 = OpVectorShuffle %135 %135 0 0 
                                     f32 %137 = OpDot %134 %136 
                                                  OpStore %89 %137 
                                   f32_3 %141 = OpLoad %61 
                                   f32_4 %142 = OpVectorShuffle %141 %141 0 1 2 0 
                                  bool_4 %146 = OpFOrdLessThan %142 %144 
                                  bool_3 %147 = OpVectorShuffle %146 %146 0 1 2 
                                                  OpStore %140 %147 
                           Private bool* %150 = OpAccessChain %140 %149 
                                    bool %151 = OpLoad %150 
                            ...
                            Private f32* %171 = OpAccessChain %26 %149 
                                                  OpStore %171 %170 
                           Private bool* %172 = OpAccessChain %140 %59 
                                    bool %173 = OpLoad %172 
                            ...
                            Private f32* %183 = OpAccessChain %148 %59 
                                                  OpStore %183 %182 
                           Private bool* %184 = OpAccessChain %140 %18 
                                    bool %185 = OpLoad %184 
