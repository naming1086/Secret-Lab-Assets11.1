...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %90 
...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
            ...
            UniformConstant sampler* %37 = OpVariable UniformConstant 
                      ...
                      Private f32_3* %53 = OpVariable Private 
                               ...
                               f32_3 %81 = OpConstantComposite %78 %79 %80 
                                     %89 = OpTypePointer Output %14 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %66 = OpAccessChain %53 %60 
                               ...
                               f32_3 %88 = OpFAdd %86 %87 
                                             OpStore %53 %88 
                        Uniform f32* %92 = OpAccessChain %17 %91 
                                 f32 %93 = OpLoad %92 
                        Uniform f32* %94 = OpAccessChain %17 %91 
                                 f32 %95 = OpLoad %94 
                        Uniform f32* %96 = OpAccessChain %17 %91 
                                 f32 %97 = OpLoad %96 
                              ...
                              f32_4 %108 = OpVectorShuffle %107 %106 4 5 6 3 
                                             OpStore %90 %108 
                        Output f32* %111 = OpAccessChain %90 %109 
                                             OpStore %111 %57 
                                             OpReturn
                                             OpFunctionEnd
"
