...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %102 
...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %80 = OpAccessChain %53 %60 
                                 f32 %81 = OpLoad %80 
                                 f32 %82 = OpExtInst %1 8 %81 
                        Private f32* %83 = OpAccessChain %53 %60 
                                             OpStore %83 %82 
                       ...
                       Uniform f32* %104 = OpAccessChain %17 %103 
                                f32 %105 = OpLoad %104 
                       Uniform f32* %106 = OpAccessChain %17 %103 
                                f32 %107 = OpLoad %106 
                       Uniform f32* %108 = OpAccessChain %17 %103 
                                f32 %109 = OpLoad %108 
                              ...
                              f32_4 %120 = OpVectorShuffle %119 %118 4 5 6 3 
                                             OpStore %102 %120 
                        Output f32* %123 = OpAccessChain %102 %121 
                                             OpStore %123 %57 
                                             OpReturn
                                             OpFunctionEnd
"
