...
void main()
{
    ...
    SV_Target0 = vec4(vec4(_Fade, _Fade, _Fade, _Fade)) * u_xlat1 + u_xlat0;
    return;
}
...
UniformConstant read_only Texture2D* %32 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %39 = OpSampledImage %33 %37 
                        ...
                        Uniform f32* %55 = OpAccessChain %16 %53 
                                 f32 %56 = OpLoad %55 
                        Uniform f32* %57 = OpAccessChain %16 %53 
                                 f32 %58 = OpLoad %57 
                        Uniform f32* %59 = OpAccessChain %16 %53 
                                 f32 %60 = OpLoad %59 
                        Uniform f32* %61 = OpAccessChain %16 %53 
                                 f32 %62 = OpLoad %61 
