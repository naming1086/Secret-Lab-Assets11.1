...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %11 %32 %48 
                      ...
                      Private f32_4* %19 = OpVariable Private 
...
UniformConstant read_only Texture2D* %22 = OpVariable UniformConstant 
               ...
               Input f32_2* vs_TEXCOORD0 = OpVariable Input 
                       ...
                       Output f32_4* %48 = OpVariable Output 
                          ...
                          Input f32* %15 = OpAccessChain %11 %13 
                                 f32 %16 = OpLoad %15 
                        Private f32* %18 = OpAccessChain %9 %13 
                                             OpStore %18 %16 
          ...
          read_only Texture2DSampled %29 = OpSampledImage %23 %27 
                          ...
                          Input f32* %43 = OpAccessChain %11 %13 
                                 f32 %44 = OpLoad %43 
                        Private f32* %46 = OpAccessChain %19 %45 
                                             OpStore %46 %44 
                               f32_4 %49 = OpLoad %19 
                               f32_4 %50 = OpVectorShuffle %49 %49 0 0 0 3 
                               f32_4 %51 = OpLoad %9 
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %11 %82 %103 %117 
                                             OpExecutionMode %4 OriginUpperLeft 
                                             OpName vs_TEXCOORD1 "vs_TEXCOORD1" 
                                             OpName vs_TEXCOORD0 "vs_TEXCOORD0" 
...
UniformConstant read_only Texture2D* %97 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %29 = OpSampledImage %23 %27 
                        ...
                        Private f32* %86 = OpAccessChain %9 %50 
                                             OpStore %86 %85 
                        Private f32* %88 = OpAccessChain %9 %50 
                                 f32 %89 = OpLoad %88 
                        Private f32* %90 = OpAccessChain %87 %50 
                                             OpStore %90 %89 
                               f32_4 %92 = OpLoad %82 
         ...
         read_only Texture2DSampled %101 = OpSampledImage %98 %100 
                              ...
                              f32_4 %105 = OpImageSampleImplicitLod %101 %104 
                                             OpStore %96 %105 
                              f32_4 %106 = OpLoad %96 
                              ...
                              f32_4 %112 = OpFMul %110 %111 
                                             OpStore %9 %112 
                       Private f32* %113 = OpAccessChain %87 %50 
                                f32 %114 = OpLoad %113 
                       Private f32* %115 = OpAccessChain %96 %34 
                                             OpStore %115 %114 
                              f32_4 %118 = OpLoad %96 
                              f32_4 %119 = OpVectorShuffle %118 %118 0 0 0 3 
                              f32_4 %120 = OpLoad %9 
