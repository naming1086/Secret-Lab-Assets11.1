...
void main()
{
    ...
    u_xlat1.xyz = vec3(u_xlat5) * u_xlat1.xxx + u_xlat2.xyz;
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %370 
                     ...
                     Private f32_2* %128 = OpVariable Private 
                      ...
                      Private bool* %204 = OpVariable Private 
                       ...
                       Private f32* %242 = OpVariable Private 
                              ...
                              f32_3 %286 = OpConstantComposite %98 %98 %98 
         ...
         read_only Texture2DSampled %237 = OpSampledImage %235 %236 
                       ...
                       Private f32* %267 = OpAccessChain %68 %134 
                                ...
                                f32 %272 = OpFAdd %270 %271 
                                             OpStore %242 %272 
                       Private f32* %273 = OpAccessChain %68 %63 
                                f32 %274 = OpLoad %273 
                                f32 %275 = OpFMul %274 %59 
                                f32 %276 = OpLoad %242 
                                f32 %277 = OpFAdd %275 %276 
                       Private f32* %278 = OpAccessChain %68 %63 
                                             OpStore %278 %277 
                              f32_4 %279 = OpLoad %9 
                       ...
                       Private f32* %284 = OpAccessChain %9 %63 
                                             OpStore %284 %283 
                              f32_3 %285 = OpLoad %92 
                              ...
                              f32_3 %291 = OpFAdd %287 %290 
                                             OpStore %68 %291 
                       Uniform f32* %292 = OpAccessChain %17 %244 
                                f32 %293 = OpLoad %292 
                              f32_2 %294 = OpCompositeConstruct %293 %293 
                              f32_2 %298 = OpFMul %294 %297 
                              f32_2 %302 = OpFAdd %298 %301 
                              f32_4 %303 = OpLoad %35 
                              f32_4 %304 = OpVectorShuffle %303 %302 4 5 2 3 
                                             OpStore %35 %304 
                       Private f32* %305 = OpAccessChain %35 %63 
                                f32 %306 = OpLoad %305 
                                f32 %307 = OpFNegate %306 
                       Private f32* %308 = OpAccessChain %35 %134 
                                f32 %309 = OpLoad %308 
                                f32 %310 = OpFAdd %307 %309 
                       Private f32* %311 = OpAccessChain %29 %63 
                                             OpStore %311 %310 
                       Private f32* %313 = OpAccessChain %29 %63 
                                f32 %314 = OpLoad %313 
                                f32 %315 = OpFDiv %312 %314 
                       Private f32* %316 = OpAccessChain %29 %63 
                                             OpStore %316 %315 
                       Private f32* %317 = OpAccessChain %29 %63 
                                f32 %318 = OpLoad %317 
                       Private f32* %319 = OpAccessChain %35 %63 
                                f32 %320 = OpLoad %319 
                                f32 %321 = OpFNegate %320 
                                f32 %322 = OpFMul %318 %321 
                       Private f32* %323 = OpAccessChain %29 %63 
                                             OpStore %323 %322 
                       Private f32* %324 = OpAccessChain %29 %63 
                                f32 %325 = OpLoad %324 
                                f32 %326 = OpExtInst %1 43 %325 %31 %312 
                       Private f32* %327 = OpAccessChain %29 %63 
                                             OpStore %327 %326 
                       Private f32* %328 = OpAccessChain %29 %63 
                                f32 %329 = OpLoad %328 
                                f32 %331 = OpFMul %329 %330 
                                f32 %333 = OpFAdd %331 %332 
                       Private f32* %334 = OpAccessChain %35 %63 
                                             OpStore %334 %333 
                       Private f32* %335 = OpAccessChain %29 %63 
                                f32 %336 = OpLoad %335 
                       Private f32* %337 = OpAccessChain %29 %63 
                                f32 %338 = OpLoad %337 
                                f32 %339 = OpFMul %336 %338 
                       Private f32* %340 = OpAccessChain %29 %63 
                                             OpStore %340 %339 
                              f32_4 %341 = OpLoad %35 
                              ...
                              f32_3 %353 = OpFAdd %350 %352 
                                             OpStore %68 %353 
                       Private f32* %356 = OpAccessChain %29 %63 
                                f32 %357 = OpLoad %356 
                               bool %358 = OpFOrdLessThan %355 %357 
                                             OpStore %354 %358 
                               bool %359 = OpLoad %354 
                                             OpSelectionMerge %363 None 
                                             OpBranchConditional %359 %362 %365 
                                    %362 = OpLabel 
                              f32_3 %364 = OpLoad %68 
                                             OpStore %361 %364 
                                             OpBranch %363 
                              ...
                              f32_4 %376 = OpVectorShuffle %375 %374 4 5 6 3 
                                             OpStore %370 %376 
                        Output f32* %379 = OpAccessChain %370 %377 
                                             OpStore %379 %312 
                                             OpReturn
                                             OpFunctionEnd
"
