...
void main()
{
    ...
    u_xlat2.x = u_xlat1.z + (-_Value2);
    u_xlat2.z = min(u_xlat10, u_xlat2.x);
    u_xlat7 = u_xlat1.z + (-u_xlat2.z);
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %28 %175 
         ...
         UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                   ...
                   read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                                        ...
                                        f32_3 %84 = OpVectorShuffle %83 %83 0 1 2 
                                                      OpStore %26 %84 
                                 Private f32* %86 = OpAccessChain %61 %59 
                                          f32 %87 = OpLoad %86 
                                 Uniform f32* %89 = OpAccessChain %14 %88 
                                          ...
                                          f32 %92 = OpFAdd %87 %91 
                                                      OpStore %85 %92 
                                 Private f32* %94 = OpAccessChain %61 %18 
                                          f32 %95 = OpLoad %94 
                                ...
                                Private f32* %125 = OpAccessChain %100 %59 
                                                      OpStore %125 %124 
                                Private f32* %127 = OpAccessChain %61 %59 
                                         f32 %128 = OpLoad %127 
                                Private f32* %129 = OpAccessChain %100 %59 
                                         f32 %130 = OpLoad %129 
                                       ...
                                       f32_3 %135 = OpLoad %100 
                                       f32_3 %136 = OpVectorShuffle %135 %134 3 4 2 
                                                      OpStore %100 %136 
                                         f32 %137 = OpLoad %126 
                                Uniform f32* %139 = OpAccessChain %14 %138 
                                         f32 %140 = OpLoad %139 
                                         f32 %141 = OpFNegate %140 
                                         f32 %142 = OpFAdd %137 %141 
                                Private f32* %143 = OpAccessChain %61 %96 
                                                      OpStore %143 %142 
                                       f32_3 %144 = OpLoad %61 
                                       ...
                                       f32_3 %147 = OpFAdd %145 %146 
                                                      OpStore %61 %147 
                                       f32_3 %148 = OpLoad %61 
                                Uniform f32* %150 = OpAccessChain %14 %149 
                                         f32 %151 = OpLoad %150 
                                Uniform f32* %153 = OpAccessChain %14 %152 
                                         f32 %154 = OpLoad %153 
                                Uniform f32* %156 = OpAccessChain %14 %155 
                                         f32 %157 = OpLoad %156 
                                       f32_3 %158 = OpCompositeConstruct %151 %154 %157 
                                       f32_3 %159 = OpFAdd %148 %158 
                                                      OpStore %61 %159 
                                       f32_3 %160 = OpLoad %61 
                                       ...
                                       f32_3 %173 = OpFAdd %171 %172 
                                                      OpStore %61 %173 
                                Uniform f32* %177 = OpAccessChain %14 %176 
                                         f32 %178 = OpLoad %177 
                                Uniform f32* %179 = OpAccessChain %14 %176 
                                         f32 %180 = OpLoad %179 
                                Uniform f32* %181 = OpAccessChain %14 %176 
                                         f32 %182 = OpLoad %181 
                                       f32_3 %183 = OpCompositeConstruct %178 %180 %182 
                                         f32 %184 = OpCompositeExtract %183 0 
                                         f32 %185 = OpCompositeExtract %183 1 
                                         f32 %186 = OpCompositeExtract %183 2 
                                       f32_3 %187 = OpCompositeConstruct %184 %185 %186 
                                       f32_3 %188 = OpLoad %61 
                                       ...
                                       f32_4 %193 = OpVectorShuffle %192 %191 4 5 6 3 
                                                      OpStore %175 %193 
                                 Output f32* %196 = OpAccessChain %175 %194 
                                                      OpStore %196 %47 
                                                      OpReturn
                                                      OpFunctionEnd
"
