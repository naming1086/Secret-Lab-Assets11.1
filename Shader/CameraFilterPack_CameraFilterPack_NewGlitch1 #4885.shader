...
void main()
{
    ...
    u_xlat1.x = (-u_xlat1.x) * 0.333333343 + 1.0;
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %55 %156 
...
UniformConstant read_only Texture2D* %74 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %81 = OpSampledImage %75 %79 
                               ...
                               f32_3 %84 = OpVectorShuffle %83 %83 0 1 2 
                                             OpStore %71 %84 
                        Private f32* %85 = OpAccessChain %71 %28 
                                 f32 %86 = OpLoad %85 
                        Private f32* %87 = OpAccessChain %71 %22 
                                 f32 %88 = OpLoad %87 
                                 f32 %89 = OpFAdd %86 %88 
                        Private f32* %90 = OpAccessChain %71 %22 
                                             OpStore %90 %89 
                        Private f32* %92 = OpAccessChain %71 %91 
                                 f32 %93 = OpLoad %92 
                        Private f32* %94 = OpAccessChain %71 %22 
                                 f32 %95 = OpLoad %94 
                                 f32 %96 = OpFAdd %93 %95 
                        Private f32* %97 = OpAccessChain %71 %22 
                                             OpStore %97 %96 
                        Private f32* %98 = OpAccessChain %71 %22 
                                 f32 %99 = OpLoad %98 
                                f32 %100 = OpFNegate %99 
                                f32 %102 = OpFMul %100 %101 
                                f32 %103 = OpFAdd %102 %49 
                       Private f32* %104 = OpAccessChain %71 %22 
                                             OpStore %104 %103 
                       Private f32* %105 = OpAccessChain %71 %22 
                                f32 %106 = OpLoad %105 
                                f32 %107 = OpExtInst %1 30 %106 
                       Private f32* %108 = OpAccessChain %71 %22 
                                             OpStore %108 %107 
                       Private f32* %109 = OpAccessChain %9 %22 
                                f32 %110 = OpLoad %109 
                       Private f32* %111 = OpAccessChain %71 %22 
                                f32 %112 = OpLoad %111 
                                f32 %113 = OpFMul %110 %112 
                       Private f32* %114 = OpAccessChain %9 %22 
                                             OpStore %114 %113 
                       Private f32* %115 = OpAccessChain %9 %22 
                                f32 %116 = OpLoad %115 
                                f32 %117 = OpExtInst %1 29 %116 
                       Private f32* %118 = OpAccessChain %9 %22 
                                             OpStore %118 %117 
                       Private f32* %119 = OpAccessChain %9 %22 
                                f32 %120 = OpLoad %119 
                       Private f32* %121 = OpAccessChain %38 %22 
                                f32 %122 = OpLoad %121 
                                f32 %123 = OpFMul %120 %122 
                       Private f32* %124 = OpAccessChain %38 %22 
                                             OpStore %124 %123 
                       Private f32* %125 = OpAccessChain %38 %22 
                                f32 %126 = OpLoad %125 
                                f32 %127 = OpFDiv %49 %126 
                       Private f32* %128 = OpAccessChain %71 %22 
                                             OpStore %128 %127 
                              f32_2 %129 = OpLoad vs_TEXCOORD0 
                              f32_3 %130 = OpLoad %71 
                              f32_2 %131 = OpVectorShuffle %130 %130 0 0 
                              f32_2 %132 = OpFMul %129 %131 
                              f32_2 %133 = OpFAdd %132 %61 
                              f32_3 %134 = OpLoad %71 
                              ...
                              f32_2 %154 = OpFAdd %152 %153 
                                             OpStore %9 %154 
                read_only Texture2D %157 = OpLoad %74 
                            sampler %158 = OpLoad %78 
