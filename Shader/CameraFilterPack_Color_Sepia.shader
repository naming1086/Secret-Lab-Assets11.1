...
void main()
{
    ...
    u_xlat6 = dot(u_xlat0.xyz, vec3(0.222000003, 0.707000017, 0.0710000023));
    u_xlat1.xyz = vec3(u_xlat6) + vec3(0.437000006, 0.171000004, 0.0780000016);
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %66 
...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Uniform f32* %69 = OpAccessChain %17 %67 
                                 f32 %70 = OpLoad %69 
                        Uniform f32* %71 = OpAccessChain %17 %67 
                                 f32 %72 = OpLoad %71 
                        Uniform f32* %73 = OpAccessChain %17 %67 
                                 f32 %74 = OpLoad %73 
                               ...
                               f32_4 %85 = OpVectorShuffle %84 %83 4 5 6 3 
                                             OpStore %66 %85 
                         Output f32* %90 = OpAccessChain %66 %88 
                                             OpStore %90 %86 
                                             OpReturn
                                             OpFunctionEnd
"
