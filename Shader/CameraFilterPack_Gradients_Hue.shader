...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
            ...
            UniformConstant sampler* %37 = OpVariable UniformConstant 
                      ...
                      Private f32_3* %53 = OpVariable Private 
                               ...
                               f32_3 %75 = OpConstantComposite %57 %73 %74 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %66 = OpAccessChain %53 %60 
                               ...
                               f32_3 %76 = OpFAdd %72 %75 
                                             OpStore %53 %76 
                               f32_3 %77 = OpLoad %53 
                               f32_3 %78 = OpExtInst %1 10 %77 
                                             OpStore %53 %78 
                               f32_3 %79 = OpLoad %53 
                               ...
                               f32_3 %94 = OpCompositeConstruct %57 %57 %57 
                               f32_3 %95 = OpExtInst %1 43 %91 %93 %94 
                                             OpStore %53 %95 
                               f32_3 %96 = OpLoad %9 
                               ...
                               f32_3 %99 = OpFAdd %97 %98 
                                             OpStore %53 %99 
                       Uniform f32* %103 = OpAccessChain %17 %102 
                                f32 %104 = OpLoad %103 
                       Uniform f32* %105 = OpAccessChain %17 %102 
                                f32 %106 = OpLoad %105 
                       Uniform f32* %107 = OpAccessChain %17 %102 
                                f32 %108 = OpLoad %107 
