...
void main()
{
    ...
    u_xlat0.xyz = u_xlat0.xyz + (-vec3(vec3(levelMinimum, levelMinimum, levelMinimum)));
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %12 %103 
         ...
         UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
                   ...
                   read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                                 ...
                                 Uniform f32* %48 = OpAccessChain %17 %46 
                                          f32 %49 = OpLoad %48 
                                 Uniform f32* %50 = OpAccessChain %17 %46 
                                          f32 %51 = OpLoad %50 
                                 Uniform f32* %52 = OpAccessChain %17 %46 
                                          f32 %53 = OpLoad %52 
                                        f32_3 %54 = OpCompositeConstruct %49 %51 %53 
                                          f32 %55 = OpCompositeExtract %54 0 
                                          f32 %56 = OpCompositeExtract %54 1 
                                          f32 %57 = OpCompositeExtract %54 2 
                                        f32_3 %58 = OpCompositeConstruct %55 %56 %57 
                                        f32_3 %59 = OpFNegate %58 
                                        f32_3 %60 = OpFAdd %45 %59 
                                                      OpStore %9 %60 
                                        f32_3 %61 = OpLoad %9 
                                        f32_3 %64 = OpExtInst %1 40 %61 %63 
                                                      OpStore %9 %64 
                                 Uniform f32* %67 = OpAccessChain %17 %46 
                                          f32 %68 = OpLoad %67 
                                          f32 %69 = OpFNegate %68 
                                 Uniform f32* %71 = OpAccessChain %17 %70 
                                        ...
                                        f32_3 %77 = OpFDiv %74 %76 
                                                      OpStore %9 %77 
                                        f32_3 %78 = OpLoad %9 
                                        f32_3 %81 = OpExtInst %1 37 %78 %80 
                                                      OpStore %9 %81 
                                        f32_3 %82 = OpLoad %9 
