...
void main()
{
    ...
    u_xlat2 = texture(_MainTex, u_xlat0.zy);
    u_xlat0 = texture(_MainTex, u_xlat0.xw);
    u_xlat0.x = dot(u_xlat0.xyz, vec3(0.330000013, 0.330000013, 0.330000013));
    u_xlat3 = dot(u_xlat2.xyz, vec3(0.330000013, 0.330000013, 0.330000013));
    u_xlat6 = (-_Distortion) * 0.300000012 + 1.0;
    u_xlat0.w = (-u_xlat6) * u_xlat3 + u_xlat1.x;
    u_xlat3 = u_xlat0.x + u_xlat3;
    u_xlat0.x = (-u_xlat6) * u_xlat0.x + u_xlat1.y;
    u_xlat3 = u_xlat3 * 0.5;
    ...
    SV_Target0.y = u_xlat0.x * u_xlat3 + u_xlat6;
...
UniformConstant read_only Texture2D* %72 = OpVariable UniformConstant 
            ...
            UniformConstant sampler* %76 = OpVariable UniformConstant 
                    ...
                    Private bool_4* %145 = OpVariable Private 
                                    %152 = OpTypeVector %142 2 
                                    %156 = OpTypePointer Private %142 
                                f32 %165 = OpConstant 3.674022E-40 
                                    %176 = OpTypePointer Output %7 
                      Output f32_4* %177 = OpVariable Output 
                                    %184 = OpTypePointer Output %6 
                              f32_3 %186 = OpConstantComposite %165 %165 %111 
                                 void %4 = OpFunction None %3 
                                      %5 = OpLabel 
          ...
          read_only Texture2DSampled %79 = OpSampledImage %73 %77 
                               ...
                               f32_3 %83 = OpVectorShuffle %82 %82 0 1 2 
                                             OpStore %69 %83 
                 read_only Texture2D %84 = OpLoad %72 
                             sampler %85 = OpLoad %76 
          read_only Texture2DSampled %86 = OpSampledImage %84 %85 
                       ...
                       Private f32* %101 = OpAccessChain %9 %99 
                                             OpStore %101 %97 
                              f32_3 %103 = OpLoad %69 
                                f32 %104 = OpDot %103 %96 
                                             OpStore %102 %104 
                       Uniform f32* %106 = OpAccessChain %16 %44 
                                f32 %107 = OpLoad %106 
                       ...
                       Private f32* %117 = OpAccessChain %31 %99 
                                f32 %118 = OpLoad %117 
                                f32 %119 = OpFAdd %116 %118 
                       Private f32* %121 = OpAccessChain %9 %120 
                                             OpStore %121 %119 
                       Private f32* %122 = OpAccessChain %9 %99 
                                f32 %123 = OpLoad %122 
                                f32 %124 = OpLoad %102 
                       ...
                       Private f32* %128 = OpAccessChain %9 %99 
                                f32 %129 = OpLoad %128 
                                f32 %130 = OpFMul %127 %129 
                       Private f32* %132 = OpAccessChain %31 %131 
                                f32 %133 = OpLoad %132 
                                f32 %134 = OpFAdd %130 %133 
                       Private f32* %135 = OpAccessChain %9 %99 
                                             OpStore %135 %134 
                                f32 %136 = OpLoad %102 
                                f32 %138 = OpFMul %136 %137 
                                             OpStore %102 %138 
                       Uniform f32* %139 = OpAccessChain %16 %44 
                                f32 %140 = OpLoad %139 
                                f32 %141 = OpFMul %140 %55 
                                             OpStore %105 %141 
                              f32_4 %146 = OpLoad %9 
                              f32_4 %147 = OpVectorShuffle %146 %146 0 0 0 3 
                              f32_4 %148 = OpExtInst %1 4 %147 
                                f32 %149 = OpLoad %105 
                              f32_4 %150 = OpCompositeConstruct %149 %149 %149 %149 
                             bool_4 %151 = OpFOrdLessThan %148 %150 
                             bool_2 %153 = OpVectorShuffle %151 %151 0 3 
                             bool_4 %154 = OpLoad %145 
                             bool_4 %155 = OpVectorShuffle %154 %153 4 1 2 5 
                                             OpStore %145 %155 
                      Private bool* %157 = OpAccessChain %145 %99 
                               bool %158 = OpLoad %157 
                      Private bool* %159 = OpAccessChain %145 %120 
                               bool %160 = OpLoad %159 
                               bool %161 = OpLogicalOr %158 %160 
                      Private bool* %162 = OpAccessChain %145 %99 
                                             OpStore %162 %161 
                      Private bool* %163 = OpAccessChain %145 %99 
                               bool %164 = OpLoad %163 
                                f32 %166 = OpSelect %164 %165 %111 
                                             OpStore %105 %166 
                      Private bool* %167 = OpAccessChain %145 %99 
                               bool %168 = OpLoad %167 
                                f32 %169 = OpSelect %168 %111 %165 
                       Private f32* %170 = OpAccessChain %9 %99 
                                             OpStore %170 %169 
                                f32 %171 = OpLoad %102 
                                f32 %172 = OpLoad %105 
                                f32 %173 = OpFMul %171 %172 
                                             OpStore %105 %173 
                                f32 %174 = OpLoad %105 
                                f32 %175 = OpFMul %174 %109 
                                             OpStore %105 %175 
                       Private f32* %178 = OpAccessChain %9 %99 
                                f32 %179 = OpLoad %178 
                                f32 %180 = OpLoad %102 
                                f32 %181 = OpFMul %179 %180 
                                f32 %182 = OpLoad %105 
                                f32 %183 = OpFAdd %181 %182 
                        Output f32* %185 = OpAccessChain %177 %131 
                                             OpStore %185 %183 
