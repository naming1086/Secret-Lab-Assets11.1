...
void main()
{
    ...
    SV_Target0 = vec4(vec4(_Value, _Value, _Value, _Value)) * u_xlat1 + u_xlat0;
    return;
}
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %27 %87 
...
UniformConstant read_only Texture2D* %74 = OpVariable UniformConstant 
            UniformConstant sampler* %76 = OpVariable UniformConstant 
                      ...
                      Uniform f32_4* %35 = OpAccessChain %14 %29 
                               ...
                               f32_4 %40 = OpVectorShuffle %39 %38 4 5 2 3 
                                             OpStore %25 %40 
                        Private f32* %43 = OpAccessChain %25 %18 
                                 f32 %44 = OpLoad %43 
                                 f32 %45 = OpFNegate %44 
                                 f32 %47 = OpFAdd %45 %46 
                                             OpStore %42 %47 
                                bool %48 = OpLoad %8 
                                 ...
                                 f32 %53 = OpLoad %42 
                                             ...
                                             OpBranch %52 
                                     %54 = OpLabel 
                        Private f32* %55 = OpAccessChain %25 %18 
                                 f32 %56 = OpLoad %55 
                                             OpStore %50 %56 
                                             OpBranch %52 
                                     %52 = OpLabel 
                                 f32 %57 = OpLoad %50 
                        Private f32* %59 = OpAccessChain %25 %58 
                                             OpStore %59 %57 
          ...
          read_only Texture2DSampled %78 = OpSampledImage %75 %77 
                               f32_4 %79 = OpLoad %25 
                        ...
                        Uniform f32* %89 = OpAccessChain %14 %88 
                                 f32 %90 = OpLoad %89 
                        Uniform f32* %91 = OpAccessChain %14 %88 
                                 f32 %92 = OpLoad %91 
                        Uniform f32* %93 = OpAccessChain %14 %88 
                                 f32 %94 = OpLoad %93 
                        Uniform f32* %95 = OpAccessChain %14 %88 
                                 f32 %96 = OpLoad %95 
                               f32_4 %97 = OpCompositeConstruct %90 %92 %94 %96 
                                ...
                                f32 %101 = OpCompositeExtract %97 3 
                              f32_4 %102 = OpCompositeConstruct %98 %99 %100 %101 
                              f32_4 %103 = OpLoad %60 
