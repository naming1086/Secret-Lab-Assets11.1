...
#define UNITY_BINDING(x) layout(std140)
#endif
uniform 	float _DarknessIntensity;
...
void main()
{
    ...
    SV_Target0.xyz = vec3(_DarknessIntensity) * (-u_xlat0.xyz) + u_xlat0.xyz;
...
UniformConstant read_only Texture2D* %12 = OpVariable UniformConstant 
            ...
            UniformConstant sampler* %16 = OpVariable UniformConstant 
              ...
              Uniform struct {f32;}* %29 = OpVariable Uniform 
                                     %30 = OpTypeInt 32 1 
                                 i32 %31 = OpConstant 0 
          ...
          read_only Texture2DSampled %19 = OpSampledImage %13 %17 
                        ...
                        Private f32* %49 = OpAccessChain %9 %47 
                                 f32 %50 = OpLoad %49 
                         Output f32* %52 = OpAccessChain %26 %47 
                                             OpStore %52 %50 
                                             OpReturn
                                             OpFunctionEnd
"
