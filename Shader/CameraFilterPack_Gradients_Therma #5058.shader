...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %79 = OpAccessChain %53 %60 
                                 f32 %80 = OpLoad %79 
                        Private f32* %81 = OpAccessChain %53 %60 
                                             OpStore %81 %80 
                        Private f32* %82 = OpAccessChain %53 %60 
                                 f32 %83 = OpLoad %82 
                                 f32 %85 = OpExtInst %1 43 %83 %84 %57 
                        Private f32* %86 = OpAccessChain %53 %60 
                                             OpStore %86 %85 
                        Private f32* %88 = OpAccessChain %53 %60 
                                 f32 %89 = OpLoad %88 
                                 f32 %90 = OpFMul %89 %55 
                                 f32 %92 = OpFAdd %90 %91 
                                             OpStore %87 %92 
                        Private f32* %93 = OpAccessChain %53 %60 
                                 f32 %94 = OpLoad %93 
                        Private f32* %95 = OpAccessChain %53 %60 
                                 f32 %96 = OpLoad %95 
                                 f32 %97 = OpFMul %94 %96 
                        Private f32* %98 = OpAccessChain %53 %60 
                                             OpStore %98 %97 
                                 f32 %99 = OpLoad %87 
                       Private f32* %100 = OpAccessChain %53 %60 
                                f32 %101 = OpLoad %100 
                                f32 %102 = OpFMul %99 %101 
                       Private f32* %104 = OpAccessChain %53 %103 
                                f32 %105 = OpLoad %104 
                                f32 %106 = OpFAdd %102 %105 
                       Private f32* %107 = OpAccessChain %53 %60 
                                             OpStore %107 %106 
                                f32 %109 = OpLoad %46 
                                ...
                                f32 %114 = OpFAdd %112 %113 
                                             OpStore %108 %114 
                                f32 %115 = OpLoad %108 
                                f32 %116 = OpExtInst %1 43 %115 %84 %57 
                                             OpStore %108 %116 
                                f32 %118 = OpLoad %108 
                                f32 %119 = OpFMul %118 %55 
                                f32 %120 = OpFAdd %119 %91 
                                             OpStore %117 %120 
                                f32 %121 = OpLoad %108 
                                f32 %122 = OpLoad %108 
                       ...
                       Private f32* %127 = OpAccessChain %53 %103 
                                             OpStore %127 %126 
                                f32 %128 = OpLoad %46 
                                f32 %129 = OpFNegate %128 
                                f32 %131 = OpFMul %129 %130 
                                f32 %132 = OpFAdd %131 %57 
                                             OpStore %108 %132 
                                f32 %133 = OpLoad %46 
                                ...
                                f32 %137 = OpFAdd %135 %136 
                                             OpStore %117 %137 
                                f32 %138 = OpLoad %46 
                                f32 %139 = OpExtInst %1 30 %138 
                                             OpStore %46 %139 
                                f32 %140 = OpLoad %46 
                                f32 %142 = OpFMul %140 %141 
                                             OpStore %46 %142 
                                f32 %143 = OpLoad %46 
                                f32 %144 = OpExtInst %1 29 %143 
                                             OpStore %46 %144 
                                f32 %145 = OpLoad %46 
                       ...
                       Private f32* %154 = OpAccessChain %53 %153 
                              ...
                              f32_3 %158 = OpFMul %156 %157 
                                             OpStore %53 %158 
                              f32_3 %159 = OpLoad %53 
                              f32_3 %160 = OpCompositeConstruct %84 %84 %84 
