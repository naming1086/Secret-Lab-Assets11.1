...
void main()
{
    ...
    u_xlat4.xy = u_xlat1.xy / vec2(vec2(_Distortion, _Distortion));
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %11 %58 
...
UniformConstant read_only Texture2D* %31 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %38 = OpSampledImage %32 %36 
                        ...
                        Uniform f32* %45 = OpAccessChain %16 %43 
                                 f32 %46 = OpLoad %45 
                        Uniform f32* %47 = OpAccessChain %16 %43 
                                 f32 %48 = OpLoad %47 
                               f32_2 %49 = OpCompositeConstruct %46 %48 
                                 f32 %50 = OpCompositeExtract %49 0 
                                 f32 %51 = OpCompositeExtract %49 1 
                               f32_2 %52 = OpCompositeConstruct %50 %51 
                               f32_2 %53 = OpFDiv %42 %52 
                                             OpStore %28 %53 
                               f32_2 %54 = OpLoad %28 
                               f32_2 %55 = OpLoad %9 
                               f32_2 %56 = OpFAdd %54 %55 
                                             OpStore %9 %56 
                 read_only Texture2D %59 = OpLoad %31 
                             sampler %60 = OpLoad %35 
