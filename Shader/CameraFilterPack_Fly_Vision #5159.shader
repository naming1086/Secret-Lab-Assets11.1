...
void main()
{
    ...
    u_xlat4.xy = u_xlat1.yx * vec2(-1.0, 1.0) + vec2(1.0, 0.0);
    u_xlat1 = texture(Texture2, u_xlat0.xy);
    u_xlat1.x = (-u_xlat1.z) + 1.0;
    u_xlat1.x = _Value3 * u_xlat1.x + u_xlat1.z;
    u_xlat4.xy = u_xlat4.xy * u_xlat1.xx + (-u_xlat0.xy);
...
Uniform struct {f32; f32; f32; f32_4;}* %16 = OpVariable Uniform 
   ...
   UniformConstant read_only Texture2D* %47 = OpVariable UniformConstant 
               ...
               UniformConstant sampler* %51 = OpVariable UniformConstant 
                                  ...
                                  f32_2 %65 = OpConstantComposite %61 %64 
  ...
  UniformConstant read_only Texture2D* %110 = OpVariable UniformConstant 
             ...
             read_only Texture2DSampled %54 = OpSampledImage %48 %52 
                                  ...
                                  f32_2 %57 = OpVectorShuffle %56 %56 0 1 
                                                OpStore %28 %57 
                                  f32_2 %58 = OpLoad %28 
                                  f32_2 %59 = OpVectorShuffle %58 %58 1 0 
                                  f32_2 %63 = OpFMul %59 %62 
                                  f32_2 %66 = OpFAdd %63 %65 
                                                OpStore %28 %66 
                    read_only Texture2D %69 = OpLoad %47 
                                sampler %70 = OpLoad %51 
