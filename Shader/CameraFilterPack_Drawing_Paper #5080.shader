...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * _Value3;
    u_xlat7.xyz = (-u_xlat1.xxx) + _PColor2.xyz;
    u_xlat7.xyz = vec3(vec3(_Value6, _Value6, _Value6)) * u_xlat7.xyz + u_xlat1.xxx;
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %60 %492 
        ...
        UniformConstant read_only Texture2D* %128 = OpVariable UniformConstant 
                    UniformConstant sampler* %130 = OpVariable UniformConstant 
                              ...
                              Private f32_3* %182 = OpVariable Private 
                                ...
                                Private f32* %285 = OpVariable Private 
                                         ...
                                         i32 %417 = OpConstant 7 
                                         i32 %452 = OpConstant 1 
                                         i32 %457 = OpConstant 8 
                                         i32 %476 = OpConstant 0 
                                             %491 = OpTypePointer Output %10 
                               Output f32_4* %492 = OpVariable Output 
                                         i32 %493 = OpConstant 9 
                                         u32 %511 = OpConstant 3 
                  ...
                  read_only Texture2DSampled %240 = OpSampledImage %238 %239 
                                ...
                                Private f32* %416 = OpAccessChain %182 %24 
                                                      OpStore %416 %415 
                                Uniform f32* %418 = OpAccessChain %13 %417 
                                         f32 %419 = OpLoad %418 
                                         f32 %420 = OpFNegate %419 
                                         f32 %421 = OpFAdd %420 %160 
                                Private f32* %422 = OpAccessChain %58 %24 
                                                      OpStore %422 %421 
                                Private f32* %423 = OpAccessChain %58 %24 
                                         f32 %424 = OpLoad %423 
                                Private f32* %425 = OpAccessChain %182 %24 
                                         f32 %426 = OpLoad %425 
                                         f32 %427 = OpFNegate %426 
                                         f32 %428 = OpFMul %424 %427 
                                Private f32* %429 = OpAccessChain %182 %24 
                                         f32 %430 = OpLoad %429 
                                         f32 %431 = OpFAdd %428 %430 
                                Private f32* %432 = OpAccessChain %182 %24 
                                                      OpStore %432 %431 
                                Private f32* %433 = OpAccessChain %182 %24 
                                         f32 %434 = OpLoad %433 
                                Private f32* %435 = OpAccessChain %9 %24 
                                         f32 %436 = OpLoad %435 
                                         f32 %437 = OpFNegate %436 
                                         f32 %438 = OpFMul %434 %437 
                                Private f32* %439 = OpAccessChain %9 %24 
                                         f32 %440 = OpLoad %439 
                                         f32 %441 = OpFAdd %438 %440 
                                Private f32* %442 = OpAccessChain %9 %24 
                                                      OpStore %442 %441 
                                Private f32* %443 = OpAccessChain %9 %24 
                                         f32 %444 = OpLoad %443 
                                Uniform f32* %445 = OpAccessChain %13 %402 
                                         f32 %446 = OpLoad %445 
                                         f32 %447 = OpFMul %444 %446 
                                Private f32* %448 = OpAccessChain %9 %24 
                                                      OpStore %448 %447 
                                       f32_3 %449 = OpLoad %32 
                              ...
                              Uniform f32_4* %453 = OpAccessChain %13 %452 
                                       ...
                                       f32_3 %456 = OpFAdd %451 %455 
                                                      OpStore %182 %456 
                                Uniform f32* %458 = OpAccessChain %13 %457 
                                         f32 %459 = OpLoad %458 
                                Uniform f32* %460 = OpAccessChain %13 %457 
                                         f32 %461 = OpLoad %460 
                                Uniform f32* %462 = OpAccessChain %13 %457 
                                         f32 %463 = OpLoad %462 
                                       f32_3 %464 = OpCompositeConstruct %459 %461 %463 
                                         f32 %465 = OpCompositeExtract %464 0 
                                         f32 %466 = OpCompositeExtract %464 1 
                                         f32 %467 = OpCompositeExtract %464 2 
                                       f32_3 %468 = OpCompositeConstruct %465 %466 %467 
                                       f32_3 %469 = OpLoad %182 
                                       f32_3 %470 = OpFMul %468 %469 
                                       f32_3 %471 = OpLoad %32 
                                       f32_3 %472 = OpVectorShuffle %471 %471 0 0 0 
                                       f32_3 %473 = OpFAdd %470 %472 
                                                      OpStore %182 %473 
                                       f32_3 %474 = OpLoad %182 
                                       f32_3 %475 = OpFNegate %474 
                              Uniform f32_4* %477 = OpAccessChain %13 %476 
                                       ...
                                       f32_3 %485 = OpLoad %182 
                                       f32_3 %486 = OpFAdd %484 %485 
                                                      OpStore %9 %486 
                                       f32_3 %487 = OpLoad %146 
                                       f32_3 %488 = OpFNegate %487 
                                       f32_3 %489 = OpLoad %9 
                                       f32_3 %490 = OpFAdd %488 %489 
                                                      OpStore %9 %490 
                                Uniform f32* %494 = OpAccessChain %13 %493 
                                         f32 %495 = OpLoad %494 
                                Uniform f32* %496 = OpAccessChain %13 %493 
                                         f32 %497 = OpLoad %496 
                                Uniform f32* %498 = OpAccessChain %13 %493 
                                         f32 %499 = OpLoad %498 
                                       f32_3 %500 = OpCompositeConstruct %495 %497 %499 
                                         f32 %501 = OpCompositeExtract %500 0 
                                         f32 %502 = OpCompositeExtract %500 1 
                                         f32 %503 = OpCompositeExtract %500 2 
                                       f32_3 %504 = OpCompositeConstruct %501 %502 %503 
                                       f32_3 %505 = OpLoad %9 
                                       f32_3 %506 = OpFMul %504 %505 
                                       f32_3 %507 = OpLoad %146 
                                       f32_3 %508 = OpFAdd %506 %507 
                                       f32_4 %509 = OpLoad %492 
                                       f32_4 %510 = OpVectorShuffle %509 %508 4 5 6 3 
                                                      OpStore %492 %510 
                                 Output f32* %513 = OpAccessChain %492 %511 
                                                      OpStore %513 %160 
                                                      OpReturn
                                                      OpFunctionEnd
"
