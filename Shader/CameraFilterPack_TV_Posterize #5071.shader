...
void main()
{
    ...
    SV_Target0 = vec4(vec4(Fade, Fade, Fade, Fade)) * u_xlat1 + u_xlat0;
    return;
}
...
UniformConstant read_only Texture2D* %32 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %39 = OpSampledImage %33 %37 
                        ...
                        Uniform f32* %47 = OpAccessChain %16 %45 
                                 f32 %48 = OpLoad %47 
                                 f32 %49 = OpFDiv %44 %48 
                        Private f32* %53 = OpAccessChain %43 %51 
                                             OpStore %53 %49 
                               f32_4 %55 = OpLoad %9 
                               f32_4 %56 = OpLoad %43 
                               ...
                               f32_4 %58 = OpFMul %55 %57 
                                             OpStore %54 %58 
                               f32_4 %59 = OpLoad %54 
                               f32_4 %60 = OpExtInst %1 8 %59 
                                             OpStore %54 %60 
                               f32_4 %61 = OpLoad %54 
                               f32_4 %62 = OpLoad %43 
                               f32_4 %63 = OpVectorShuffle %62 %62 0 0 0 0 
                               f32_4 %64 = OpFDiv %61 %63 
                                             OpStore %43 %64 
                               f32_4 %65 = OpLoad %9 
                               f32_4 %66 = OpFNegate %65 
                               f32_4 %67 = OpLoad %43 
                               f32_4 %68 = OpFAdd %66 %67 
                                             OpStore %43 %68 
                        Uniform f32* %72 = OpAccessChain %16 %71 
                                 f32 %73 = OpLoad %72 
                        Uniform f32* %74 = OpAccessChain %16 %71 
                                 f32 %75 = OpLoad %74 
                        Uniform f32* %76 = OpAccessChain %16 %71 
                                 f32 %77 = OpLoad %76 
                        Uniform f32* %78 = OpAccessChain %16 %71 
                                 f32 %79 = OpLoad %78 
