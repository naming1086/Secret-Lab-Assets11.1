...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %126 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %74 = OpAccessChain %53 %60 
                               ...
                               f32_3 %91 = OpExtInst %1 29 %90 
                                             OpStore %82 %91 
                        Private f32* %92 = OpAccessChain %53 %60 
                                 f32 %93 = OpLoad %92 
                                 ...
                                 f32 %96 = OpFAdd %95 %57 
                                             OpStore %46 %96 
                                 f32 %97 = OpLoad %46 
                                 f32 %99 = OpExtInst %1 40 %97 %98 
                                             OpStore %46 %99 
                                f32 %100 = OpLoad %46 
                                f32 %101 = OpLoad %46 
                                f32 %102 = OpFMul %100 %101 
                       Private f32* %103 = OpAccessChain %53 %60 
                                             OpStore %103 %102 
                       Private f32* %104 = OpAccessChain %53 %60 
                                f32 %105 = OpLoad %104 
                       Private f32* %106 = OpAccessChain %53 %60 
                                f32 %107 = OpLoad %106 
                                f32 %108 = OpFMul %105 %107 
                       Private f32* %109 = OpAccessChain %53 %60 
                                             OpStore %109 %108 
                                f32 %110 = OpLoad %46 
                       Private f32* %111 = OpAccessChain %53 %60 
                                f32 %112 = OpLoad %111 
                              ...
                              f32_3 %119 = OpLoad %82 
                              f32_3 %120 = OpExtInst %1 40 %118 %119 
                                             OpStore %53 %120 
                              f32_3 %121 = OpLoad %9 
                       ...
                       Uniform f32* %128 = OpAccessChain %17 %127 
                                f32 %129 = OpLoad %128 
                       Uniform f32* %130 = OpAccessChain %17 %127 
                                f32 %131 = OpLoad %130 
                       Uniform f32* %132 = OpAccessChain %17 %127 
                                f32 %133 = OpLoad %132 
                              f32_3 %134 = OpCompositeConstruct %129 %131 %133 
                                f32 %135 = OpCompositeExtract %134 0 
                                f32 %136 = OpCompositeExtract %134 1 
                                f32 %137 = OpCompositeExtract %134 2 
                              f32_3 %138 = OpCompositeConstruct %135 %136 %137 
                              f32_3 %139 = OpLoad %53 
                              f32_3 %140 = OpFMul %138 %139 
                              f32_3 %141 = OpLoad %9 
                              f32_3 %142 = OpFAdd %140 %141 
                              f32_4 %143 = OpLoad %126 
                              f32_4 %144 = OpVectorShuffle %143 %142 4 5 6 3 
                                             OpStore %126 %144 
                        Output f32* %147 = OpAccessChain %126 %145 
                                             OpStore %147 %57 
                                             OpReturn
                                             OpFunctionEnd
"
