...
void main()
{
    ...
    u_xlat1.xyz = vec3(u_xlat15) * u_xlat3.xyz + u_xlat2.xyz;
...
; Schema: 0
                                           ...
                                           %1 = OpExtInstImport "GLSL.std.450" 
                                                  OpMemoryModel Logical GLSL450 
                                                  OpEntryPoint Fragment %4 "main" %41 %317 
     ...
     UniformConstant read_only Texture2D* %86 = OpVariable UniformConstant 
                 UniformConstant sampler* %88 = OpVariable UniformConstant 
                          ...
                          Private f32_3* %193 = OpVariable Private 
                                   ...
                                   f32_3 %226 = OpConstantComposite %19 %15 %225 
                                   f32_3 %231 = OpConstantComposite %189 %189 %189 
                                     f32 %233 = OpConstant 3.674022E-40 
                                   f32_3 %234 = OpConstantComposite %233 %233 %233 
                                   f32_3 %238 = OpConstantComposite %10 %10 %10 
                                   f32_3 %250 = OpConstantComposite %19 %19 %19 
                           ...
                           Output f32_4* %317 = OpVariable Output 
                                     i32 %318 = OpConstant 0 
                                         %337 = OpTypePointer Output %6 
                                      void %4 = OpFunction None %3 
                                           %5 = OpLabel 
               ...
               read_only Texture2DSampled %90 = OpSampledImage %87 %89 
                            ...
                            Private f32* %185 = OpAccessChain %18 %148 
                                                  OpStore %185 %184 
                            Private f32* %187 = OpAccessChain %18 %148 
                                     f32 %188 = OpLoad %187 
                            ...
                            Private f32* %200 = OpAccessChain %193 %148 
                                                  OpStore %200 %199 
                            Private f32* %201 = OpAccessChain %193 %148 
                                     f32 %202 = OpLoad %201 
                                     f32 %203 = OpLoad %186 
                                     f32 %204 = OpFDiv %202 %203 
                            Private f32* %205 = OpAccessChain %193 %148 
                                                  OpStore %205 %204 
                            Private f32* %206 = OpAccessChain %193 %148 
                                     f32 %207 = OpLoad %206 
                            Private f32* %208 = OpAccessChain %9 %12 
                                     f32 %209 = OpLoad %208 
                                     f32 %210 = OpFAdd %207 %209 
                            Private f32* %211 = OpAccessChain %193 %148 
                                                  OpStore %211 %210 
                            Private f32* %212 = OpAccessChain %9 %148 
                                     f32 %213 = OpLoad %212 
                                     f32 %214 = OpFAdd %213 %191 
                            Private f32* %215 = OpAccessChain %9 %148 
                                                  OpStore %215 %214 
                            Private f32* %216 = OpAccessChain %18 %148 
                                     f32 %217 = OpLoad %216 
                            Private f32* %218 = OpAccessChain %9 %148 
                                     f32 %219 = OpLoad %218 
                                     f32 %220 = OpFDiv %217 %219 
                            Private f32* %221 = OpAccessChain %9 %148 
                                                  OpStore %221 %220 
                                   f32_3 %222 = OpLoad %193 
                                   f32_3 %223 = OpVectorShuffle %222 %222 0 0 0 
                                   f32_3 %224 = OpExtInst %1 4 %223 
                                   f32_3 %227 = OpFAdd %224 %226 
                                                  OpStore %193 %227 
                                   f32_3 %228 = OpLoad %193 
                                   f32_3 %229 = OpExtInst %1 10 %228 
                                                  OpStore %193 %229 
                                   f32_3 %230 = OpLoad %193 
                                   f32_3 %232 = OpFMul %230 %231 
                                   f32_3 %235 = OpFAdd %232 %234 
                                                  OpStore %193 %235 
                                   f32_3 %236 = OpLoad %193 
                                   f32_3 %237 = OpExtInst %1 4 %236 
                                   f32_3 %239 = OpFAdd %237 %238 
                                                  OpStore %193 %239 
                                   f32_3 %240 = OpLoad %193 
                                   f32_3 %241 = OpCompositeConstruct %35 %35 %35 
                                   f32_3 %242 = OpCompositeConstruct %19 %19 %19 
                                   f32_3 %243 = OpExtInst %1 43 %240 %241 %242 
                                                  OpStore %193 %243 
                                   f32_3 %244 = OpLoad %193 
                                   f32_3 %245 = OpFAdd %244 %238 
                                                  OpStore %193 %245 
                                   f32_4 %246 = OpLoad %9 
                                   f32_3 %247 = OpVectorShuffle %246 %246 0 0 0 
                                   f32_3 %248 = OpLoad %193 
                                   f32_3 %249 = OpFMul %247 %248 
                                   f32_3 %251 = OpFAdd %249 %250 
                                   f32_4 %252 = OpLoad %9 
                                   f32_4 %253 = OpVectorShuffle %252 %251 4 5 6 3 
                                                  OpStore %9 %253 
                            Uniform f32* %255 = OpAccessChain %28 %100 
                                     f32 %256 = OpLoad %255 
                                   ...
                                   f32_4 %266 = OpVectorShuffle %265 %264 4 5 6 3 
                                                  OpStore %18 %266 
                            Private f32* %268 = OpAccessChain %18 %31 
                                     f32 %269 = OpLoad %268 
                            Private f32* %270 = OpAccessChain %18 %12 
                                     f32 %271 = OpLoad %270 
                                    ...
                                    bool %273 = OpLoad %267 
                                     f32 %274 = OpSelect %273 %19 %35 
                                                  OpStore %254 %274 
                            Private f32* %275 = OpAccessChain %18 %12 
                                     f32 %276 = OpLoad %275 
                                     f32 %277 = OpFNegate %276 
                            Private f32* %278 = OpAccessChain %18 %31 
                                     f32 %279 = OpLoad %278 
                            ...
                            Private f32* %284 = OpAccessChain %18 %12 
                                     f32 %285 = OpLoad %284 
                                     f32 %286 = OpFAdd %283 %285 
                                                  OpStore %254 %286 
                            Private f32* %288 = OpAccessChain %18 %148 
                                     f32 %289 = OpLoad %288 
                                     f32 %290 = OpLoad %254 
                                    bool %291 = OpFOrdGreaterThanEqual %289 %290 
                                                  OpStore %287 %291 
                                     f32 %292 = OpLoad %254 
                                     f32 %293 = OpFNegate %292 
                            Private f32* %294 = OpAccessChain %18 %148 
                                     f32 %295 = OpLoad %294 
                                     f32 %296 = OpFAdd %293 %295 
                            Private f32* %297 = OpAccessChain %18 %148 
                                                  OpStore %297 %296 
                                    bool %298 = OpLoad %287 
                                     f32 %299 = OpSelect %298 %19 %35 
                                                  OpStore %186 %299 
                                     f32 %300 = OpLoad %186 
                            Private f32* %301 = OpAccessChain %18 %148 
                                     f32 %302 = OpLoad %301 
                                   ...
                                   f32_4 %315 = OpVectorShuffle %314 %313 4 5 6 3 
                                                  OpStore %9 %315 
                            Uniform f32* %319 = OpAccessChain %28 %318 
                                     f32 %320 = OpLoad %319 
                            Uniform f32* %321 = OpAccessChain %28 %318 
                                     f32 %322 = OpLoad %321 
                            Uniform f32* %323 = OpAccessChain %28 %318 
                                     f32 %324 = OpLoad %323 
                                   f32_3 %325 = OpCompositeConstruct %320 %322 %324 
                                     f32 %326 = OpCompositeExtract %325 0 
                                     f32 %327 = OpCompositeExtract %325 1 
                                     f32 %328 = OpCompositeExtract %325 2 
                                   f32_3 %329 = OpCompositeConstruct %326 %327 %328 
                                   f32_4 %330 = OpLoad %9 
                                   f32_3 %331 = OpVectorShuffle %330 %330 0 1 2 
                                   f32_3 %332 = OpFMul %329 %331 
                                   f32_3 %333 = OpLoad %99 
                                   f32_3 %334 = OpFAdd %332 %333 
                                   f32_4 %335 = OpLoad %317 
                                   f32_4 %336 = OpVectorShuffle %335 %334 4 5 6 3 
                                                  OpStore %317 %336 
                             Output f32* %338 = OpAccessChain %317 %16 
                                                  OpStore %338 %19 
                                                  OpReturn
                                                  OpFunctionEnd
"
