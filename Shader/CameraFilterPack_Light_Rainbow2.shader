...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %199 
...
UniformConstant read_only Texture2D* %42 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %49 = OpSampledImage %43 %47 
                               ...
                               f32_3 %53 = OpVectorShuffle %52 %52 0 1 2 
                                             OpStore %9 %53 
                        Private f32* %57 = OpAccessChain %32 %55 
                                 f32 %58 = OpLoad %57 
                        Uniform f32* %61 = OpAccessChain %17 %59 
                                 f32 %62 = OpLoad %61 
                                 f32 %63 = OpFMul %58 %62 
                        Private f32* %65 = OpAccessChain %32 %64 
                                             OpStore %65 %63 
                        Private f32* %67 = OpAccessChain %32 %64 
                                 f32 %68 = OpLoad %67 
                        Private f32* %70 = OpAccessChain %32 %69 
                                 f32 %71 = OpLoad %70 
                                 f32 %72 = OpFMul %68 %71 
                                             OpStore %66 %72 
                                 f32 %73 = OpLoad %66 
                        ...
                        Uniform f32* %77 = OpAccessChain %17 %76 
                               ...
                               f32_4 %91 = OpVectorShuffle %90 %89 4 5 2 3 
                                             OpStore %32 %91 
                        Uniform f32* %92 = OpAccessChain %17 %76 
                                 f32 %93 = OpLoad %92 
                                 f32 %95 = OpFMul %93 %94 
                                             OpStore %66 %95 
                        Private f32* %96 = OpAccessChain %32 %69 
                                 f32 %97 = OpLoad %96 
                                 f32 %99 = OpFMul %97 %98 
                                f32 %100 = OpLoad %66 
                              ...
                              f32_3 %119 = OpFMul %116 %118 
                                             OpStore %114 %119 
                              f32_3 %120 = OpLoad %114 
                              f32_3 %121 = OpExtInst %1 8 %120 
                                             OpStore %114 %121 
                              f32_3 %122 = OpLoad %114 
                              f32_3 %123 = OpFNegate %122 
                              f32_3 %124 = OpFMul %123 %105 
                              f32_4 %125 = OpLoad %32 
                              f32_3 %126 = OpVectorShuffle %125 %125 0 2 3 
                              f32_3 %127 = OpFAdd %124 %126 
                              f32_4 %128 = OpLoad %32 
                              f32_4 %129 = OpVectorShuffle %128 %127 4 1 5 6 
                                             OpStore %32 %129 
                              f32_4 %130 = OpLoad %32 
                              ...
                              f32_4 %136 = OpVectorShuffle %135 %134 4 1 5 6 
                                             OpStore %32 %136 
                              f32_4 %137 = OpLoad %32 
                              f32_3 %138 = OpVectorShuffle %137 %137 0 2 3 
                              f32_3 %139 = OpExtInst %1 4 %138 
                              f32_3 %142 = OpFAdd %139 %141 
                              f32_4 %143 = OpLoad %32 
                              f32_4 %144 = OpVectorShuffle %143 %142 4 1 5 6 
                                             OpStore %32 %144 
                              f32_4 %145 = OpLoad %32 
                              f32_3 %146 = OpVectorShuffle %145 %145 0 2 3 
                              f32_3 %148 = OpCompositeConstruct %107 %107 %107 
                              f32_3 %149 = OpCompositeConstruct %147 %147 %147 
                              f32_3 %150 = OpExtInst %1 43 %146 %148 %149 
                              f32_4 %151 = OpLoad %32 
                              f32_4 %152 = OpVectorShuffle %151 %150 4 1 5 6 
                                             OpStore %32 %152 
                       Private f32* %153 = OpAccessChain %32 %55 
                                f32 %154 = OpLoad %153 
                                f32 %155 = OpExtInst %1 4 %154 
                                f32 %156 = OpFNegate %155 
                                f32 %158 = OpFAdd %156 %157 
                                             OpStore %66 %158 
                       Private f32* %160 = OpAccessChain %32 %55 
                                f32 %161 = OpLoad %160 
                       Private f32* %162 = OpAccessChain %32 %55 
                                f32 %163 = OpLoad %162 
                                ...
                                f32 %174 = OpFAdd %173 %147 
                                             OpStore %159 %174 
                                f32 %175 = OpLoad %66 
                                f32 %177 = OpFMul %175 %176 
                                             OpStore %66 %177 
                                f32 %178 = OpLoad %66 
                                f32 %179 = OpExtInst %1 43 %178 %107 %147 
                                             OpStore %66 %179 
                                f32 %180 = OpLoad %66 
                              ...
                              f32_4 %205 = OpVectorShuffle %204 %203 4 5 6 3 
                                             OpStore %199 %205 
                        Output f32* %208 = OpAccessChain %199 %206 
                                             OpStore %208 %147 
                                             OpReturn
                                             OpFunctionEnd
"
