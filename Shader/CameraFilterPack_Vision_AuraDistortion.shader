...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %12 %434 
                                                      ...
                                                      OpDecorate %425 DescriptorSet 425 
                                                      OpDecorate %425 Binding 425 
                              ...
                              Private f32_2* %309 = OpVariable Private 
                                Private f32* %320 = OpVariable Private 
                                       ...
                                       f32_2 %357 = OpConstantComposite %355 %356 
                                         ...
                                         i32 %384 = OpConstant 2 
                                         u32 %400 = OpConstant 2 
                                         f32 %411 = OpConstant 3.674022E-40 
                                       f32_2 %412 = OpConstantComposite %411 %411 
                                             %419 = OpTypeImage %6 Dim2D 0 0 0 1 Unknown 
                                             %420 = OpTypePointer UniformConstant %419 
        UniformConstant read_only Texture2D* %421 = OpVariable UniformConstant 
                                             %423 = OpTypeSampler 
                                             %424 = OpTypePointer UniformConstant %423 
                    UniformConstant sampler* %425 = OpVariable UniformConstant 
                                             %427 = OpTypeSampledImage %419 
                                             %433 = OpTypePointer Output %14 
                               Output f32_4* %434 = OpVariable Output 
                                         u32 %438 = OpConstant 3 
                                             %439 = OpTypePointer Output %6 
                                             %442 = OpTypePointer Private %18 
                                Private i32* %443 = OpVariable Private 
                              ...
                              Uniform f32_4* %385 = OpAccessChain %17 %384 
                                       f32_4 %386 = OpLoad %385 
                                       f32_3 %387 = OpVectorShuffle %386 %386 0 1 2 
                                       f32_3 %388 = OpFMul %383 %387 
                                                      OpStore %45 %388 
                                         f32 %389 = OpLoad %83 
                                       f32_2 %390 = OpCompositeConstruct %389 %389 
                                       f32_3 %391 = OpLoad %45 
                                       f32_2 %392 = OpVectorShuffle %391 %391 0 1 
                                       f32_2 %393 = OpFMul %390 %392 
                                                      OpStore %32 %393 
                                Private f32* %394 = OpAccessChain %32 %61 
                                         f32 %395 = OpLoad %394 
                                Private f32* %396 = OpAccessChain %32 %54 
                                         f32 %397 = OpLoad %396 
                                         f32 %398 = OpFAdd %395 %397 
                                Private f32* %399 = OpAccessChain %32 %54 
                                                      OpStore %399 %398 
                                Private f32* %401 = OpAccessChain %45 %400 
                                         f32 %402 = OpLoad %401 
                                         f32 %403 = OpLoad %83 
                                         f32 %404 = OpFMul %402 %403 
                                Private f32* %405 = OpAccessChain %32 %54 
                                         f32 %406 = OpLoad %405 
                                         f32 %407 = OpFAdd %404 %406 
                                Private f32* %408 = OpAccessChain %32 %54 
                                                      OpStore %408 %407 
                                       f32_2 %409 = OpLoad %32 
                                       ...
                                       f32_3 %418 = OpVectorShuffle %417 %416 3 4 2 
                                                      OpStore %9 %418 
                         read_only Texture2D %422 = OpLoad %421 
                                     sampler %426 = OpLoad %425 
                  read_only Texture2DSampled %428 = OpSampledImage %422 %426 
                                       f32_3 %429 = OpLoad %9 
                                       ...
                                       f32_3 %432 = OpVectorShuffle %431 %431 0 1 2 
                                                      OpStore %9 %432 
                                       f32_3 %435 = OpLoad %9 
                                       f32_4 %436 = OpLoad %434 
                                       f32_4 %437 = OpVectorShuffle %436 %435 4 5 6 3 
                                                      OpStore %434 %437 
                                 Output f32* %440 = OpAccessChain %434 %438 
                                                      OpStore %440 %74 
                                                      OpReturn
                                                      OpFunctionEnd
"
