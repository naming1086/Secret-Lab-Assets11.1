...
; Schema: 0
                                         ...
                                         %1 = OpExtInstImport "GLSL.std.450" 
                                                OpMemoryModel Logical GLSL450 
                                                OpEntryPoint Fragment %4 "main" %12 %92 
             ...
             read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                           ...
                           Uniform f32* %49 = OpAccessChain %17 %47 
                                  ...
                                  f32_3 %55 = OpLoad %45 
                                    f32 %60 = OpDot %55 %59 
                                                OpStore %54 %60 
                                  f32_3 %61 = OpLoad %9 
                           Uniform f32* %62 = OpAccessChain %17 %47 
                                    f32 %63 = OpLoad %62 
                           ...
                           Uniform f32* %75 = OpAccessChain %17 %70 
                                  ...
                                  f32_3 %90 = OpFAdd %87 %89 
                                                OpStore %9 %90 
                           Uniform f32* %94 = OpAccessChain %17 %93 
                                    f32 %95 = OpLoad %94 
                           Uniform f32* %96 = OpAccessChain %17 %93 
                                    f32 %97 = OpLoad %96 
                           Uniform f32* %98 = OpAccessChain %17 %93 
                                    f32 %99 = OpLoad %98 
                                 ...
                                 f32_4 %111 = OpVectorShuffle %110 %109 4 5 6 3 
                                                OpStore %92 %111 
                           Output f32* %116 = OpAccessChain %92 %114 
                                                OpStore %116 %112 
                                                OpReturn
                                                OpFunctionEnd
"
