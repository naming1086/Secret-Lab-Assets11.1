...
UNITY_LOCATION(1) uniform  sampler2D _To;
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %22 %38 
...
UniformConstant read_only Texture2D* %12 = OpVariable UniformConstant 
       ...
       Uniform struct {f32; f32_4;}* %30 = OpVariable Uniform 
                                     %31 = OpTypeInt 32 1 
                                 i32 %32 = OpConstant 1 
          ...
          read_only Texture2DSampled %19 = OpSampledImage %13 %17 
                      ...
                      Uniform f32_4* %34 = OpAccessChain %30 %32 
                               f32_4 %35 = OpLoad %34 
                               f32_4 %36 = OpFAdd %27 %35 
                                             OpStore %25 %36 
                        Uniform f32* %41 = OpAccessChain %30 %39 
                                 f32 %42 = OpLoad %41 
