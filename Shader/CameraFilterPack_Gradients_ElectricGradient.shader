...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %66 = OpAccessChain %53 %60 
                                 ...
                                 f32 %71 = OpLoad %46 
                                 f32 %73 = OpFAdd %71 %72 
                        Private f32* %74 = OpAccessChain %53 %60 
                                             OpStore %74 %73 
                        Private f32* %75 = OpAccessChain %53 %60 
                                 f32 %76 = OpLoad %75 
                                 f32 %78 = OpFMul %76 %77 
                        Private f32* %79 = OpAccessChain %53 %60 
                                             OpStore %79 %78 
                        Private f32* %80 = OpAccessChain %53 %60 
                                 f32 %81 = OpLoad %80 
                                 f32 %83 = OpExtInst %1 43 %81 %82 %57 
                        Private f32* %84 = OpAccessChain %53 %60 
                                             OpStore %84 %83 
                        Private f32* %86 = OpAccessChain %53 %60 
                                 f32 %87 = OpLoad %86 
                                 f32 %88 = OpFMul %87 %55 
                                 f32 %90 = OpFAdd %88 %89 
                                             OpStore %85 %90 
                        Private f32* %91 = OpAccessChain %53 %60 
                                 f32 %92 = OpLoad %91 
                        Private f32* %93 = OpAccessChain %53 %60 
                                 f32 %94 = OpLoad %93 
                                 f32 %95 = OpFMul %92 %94 
                        Private f32* %96 = OpAccessChain %53 %60 
                                             OpStore %96 %95 
                        Private f32* %97 = OpAccessChain %53 %60 
                                 f32 %98 = OpLoad %97 
                                 f32 %99 = OpLoad %85 
                                f32 %100 = OpFMul %98 %99 
                       Private f32* %101 = OpAccessChain %53 %60 
                                             OpStore %101 %100 
                       Private f32* %102 = OpAccessChain %53 %60 
                                f32 %103 = OpLoad %102 
                       Private f32* %104 = OpAccessChain %53 %60 
                                f32 %105 = OpLoad %104 
                                f32 %106 = OpFMul %103 %105 
                       Private f32* %108 = OpAccessChain %53 %107 
                                             OpStore %108 %106 
                       Private f32* %109 = OpAccessChain %53 %107 
                                f32 %110 = OpLoad %109 
                                f32 %111 = OpExtInst %1 43 %110 %82 %57 
                       Private f32* %112 = OpAccessChain %53 %107 
                                             OpStore %112 %111 
                                f32 %114 = OpLoad %46 
                                f32 %115 = OpLoad %46 
                       ...
                       Private f32* %125 = OpAccessChain %53 %60 
                                             OpStore %125 %124 
                       Private f32* %126 = OpAccessChain %53 %60 
                                f32 %127 = OpLoad %126 
                                f32 %128 = OpExtInst %1 43 %127 %82 %57 
                       Private f32* %129 = OpAccessChain %53 %60 
                                             OpStore %129 %128 
                                f32 %130 = OpLoad %113 
                                f32 %132 = OpFMul %130 %131 
                       Private f32* %134 = OpAccessChain %53 %133 
                                             OpStore %134 %132 
                       Private f32* %135 = OpAccessChain %53 %133 
                                f32 %136 = OpLoad %135 
                                f32 %137 = OpExtInst %1 43 %136 %82 %57 
                       Private f32* %138 = OpAccessChain %53 %133 
                                             OpStore %138 %137 
                              f32_3 %139 = OpLoad %9 
                              ...
                              f32_3 %142 = OpFAdd %140 %141 
                                             OpStore %53 %142 
                       Uniform f32* %146 = OpAccessChain %17 %145 
                                f32 %147 = OpLoad %146 
                       Uniform f32* %148 = OpAccessChain %17 %145 
                                f32 %149 = OpLoad %148 
                       Uniform f32* %150 = OpAccessChain %17 %145 
                                f32 %151 = OpLoad %150 
                              f32_3 %152 = OpCompositeConstruct %147 %149 %151 
                                f32 %153 = OpCompositeExtract %152 0 
                                f32 %154 = OpCompositeExtract %152 1 
                                f32 %155 = OpCompositeExtract %152 2 
                              f32_3 %156 = OpCompositeConstruct %153 %154 %155 
                              f32_3 %157 = OpLoad %53 
                              ...
                              f32_4 %162 = OpVectorShuffle %161 %160 4 5 6 3 
                                             OpStore %144 %162 
                        Output f32* %165 = OpAccessChain %144 %163 
                                             OpStore %165 %57 
                                             OpReturn
                                             OpFunctionEnd
"
