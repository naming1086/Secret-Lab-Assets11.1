...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %128 
...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
                     ...
                     Private bool_2* %92 = OpVariable Private 
                       ...
                       Private f32* %109 = OpVariable Private 
                                ...
                                f32 %114 = OpConstant 3.674022E-40 
                                    %127 = OpTypePointer Output %14 
                      Output f32_4* %128 = OpVariable Output 
                                    %130 = OpTypePointer Function %7 
                              f32_3 %134 = OpConstantComposite %73 %72 %72 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %56 = OpAccessChain %9 %54 
                                 f32 %57 = OpLoad %56 
                        Uniform f32* %60 = OpAccessChain %17 %58 
                                 f32 %61 = OpLoad %60 
                                 f32 %62 = OpFNegate %61 
                                 f32 %63 = OpFAdd %57 %62 
                        Private f32* %64 = OpAccessChain %9 %54 
                                             OpStore %64 %63 
                        Private f32* %65 = OpAccessChain %9 %54 
                                 f32 %66 = OpLoad %65 
                                 f32 %68 = OpFMul %66 %67 
                        Private f32* %69 = OpAccessChain %9 %54 
                                             OpStore %69 %68 
                        Private f32* %70 = OpAccessChain %9 %54 
                                 f32 %71 = OpLoad %70 
                                 f32 %74 = OpExtInst %1 43 %71 %72 %73 
                        Private f32* %75 = OpAccessChain %9 %54 
                                             OpStore %75 %74 
                               f32_3 %76 = OpLoad %45 
                        ...
                        Private f32* %87 = OpAccessChain %45 %54 
                              ...
                              bool_2 %99 = OpVectorShuffle %98 %98 0 1 
                                             OpStore %92 %99 
                      Private bool* %100 = OpAccessChain %92 %54 
                               bool %101 = OpLoad %100 
                               bool %102 = OpLoad %85 
                      ...
                      Private bool* %105 = OpAccessChain %92 %104 
                               ...
                               bool %108 = OpLogicalAnd %106 %107 
                                             OpStore %85 %108 
                       Private f32* %110 = OpAccessChain %9 %54 
                                f32 %111 = OpLoad %110 
                                f32 %113 = OpFMul %111 %112 
                                f32 %115 = OpFAdd %113 %114 
                                             OpStore %109 %115 
                       Private f32* %116 = OpAccessChain %9 %54 
                                f32 %117 = OpLoad %116 
                       Private f32* %118 = OpAccessChain %9 %54 
                                f32 %119 = OpLoad %118 
                                f32 %120 = OpFMul %117 %119 
                       Private f32* %121 = OpAccessChain %9 %54 
                                             OpStore %121 %120 
                       Private f32* %122 = OpAccessChain %9 %54 
                                f32 %123 = OpLoad %122 
                                f32 %124 = OpLoad %109 
                                f32 %125 = OpFMul %123 %124 
                       Private f32* %126 = OpAccessChain %9 %54 
                                             OpStore %126 %125 
                               bool %129 = OpLoad %85 
