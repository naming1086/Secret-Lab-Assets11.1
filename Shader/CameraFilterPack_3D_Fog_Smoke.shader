...
Uniform struct {f32_4; f32_4; f32; f32_4; f32; f32; f32; f32; f32; f32_4;}* %40 = OpVariable Uniform 
        ...
        UniformConstant read_only Texture2D* %280 = OpVariable UniformConstant 
                    UniformConstant sampler* %282 = OpVariable UniformConstant 
                                         i32 %289 = OpConstant 6 
                                         f32 %296 = OpConstant 3.674022E-40 
                                       f32_4 %297 = OpConstantComposite %296 %296 %296 %296 
                                          void %4 = OpFunction None %3 
                                               %5 = OpLabel 
                  ...
                  read_only Texture2DSampled %284 = OpSampledImage %281 %283 
                                       f32_2 %285 = OpLoad %61 
                                       f32_4 %286 = OpImageSampleImplicitLod %284 %285 
                                                      OpStore %9 %286 
                                Private f32* %287 = OpAccessChain %89 %50 
                                         f32 %288 = OpLoad %287 
                                Uniform f32* %290 = OpAccessChain %40 %289 
                                         f32 %291 = OpLoad %290 
                                         f32 %292 = OpFMul %288 %291 
                                Private f32* %293 = OpAccessChain %89 %34 
                                                      OpStore %293 %292 
                                       f32_4 %294 = OpLoad %89 
                                       ...
                                       f32_4 %307 = OpFAdd %305 %306 
                                                      OpStore %89 %307 
                                Uniform f32* %308 = OpAccessChain %40 %90 
                                         f32 %309 = OpLoad %308 
