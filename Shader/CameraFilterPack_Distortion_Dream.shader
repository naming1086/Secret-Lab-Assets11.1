...
void main()
{
    ...
    u_xlat0.x = u_xlat1.x * _Distortion;
...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %38 %99 
...
UniformConstant read_only Texture2D* %70 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %77 = OpSampledImage %71 %75 
                        ...
                        Private f32* %82 = OpAccessChain %9 %22 
                                 f32 %83 = OpLoad %82 
                        Uniform f32* %84 = OpAccessChain %13 %54 
                                 f32 %85 = OpLoad %84 
                                 f32 %86 = OpFMul %83 %85 
                        ...
                        Private f32* %94 = OpAccessChain %9 %34 
                               ...
                               f32_2 %97 = OpFAdd %95 %96 
                                             OpStore %9 %97 
                read_only Texture2D %100 = OpLoad %70 
                            sampler %101 = OpLoad %74 
