     ...
     UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                 UniformConstant sampler* %78 = OpVariable UniformConstant 
                           ...
                           Private bool* %139 = OpVariable Private 
                                         %145 = OpTypePointer Function %24 
                                         %157 = OpTypePointer Output %11 
               ...
               read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                            ...
                            Uniform f32* %106 = OpAccessChain %14 %90 
                                   ...
                                   f32_3 %116 = OpFAdd %114 %115 
                                                  OpStore %61 %116 
                            Private f32* %117 = OpAccessChain %95 %18 
                                     f32 %118 = OpLoad %117 
                            Private f32* %120 = OpAccessChain %95 %119 
                                     f32 %121 = OpLoad %120 
                                     f32 %122 = OpFAdd %118 %121 
                                                  OpStore %89 %122 
                            Private f32* %123 = OpAccessChain %95 %59 
                                     f32 %124 = OpLoad %123 
                                     f32 %125 = OpLoad %89 
                            ...
                            Private f32* %127 = OpAccessChain %61 %18 
                                     f32 %128 = OpLoad %127 
                            Private f32* %129 = OpAccessChain %61 %119 
                                     f32 %130 = OpLoad %129 
                                     f32 %131 = OpFAdd %128 %130 
                            Private f32* %132 = OpAccessChain %26 %119 
                                                  OpStore %132 %131 
                            Private f32* %133 = OpAccessChain %61 %59 
                                     f32 %134 = OpLoad %133 
                            Private f32* %135 = OpAccessChain %26 %119 
                                     f32 %136 = OpLoad %135 
                                     f32 %137 = OpFAdd %134 %136 
                            Private f32* %138 = OpAccessChain %26 %119 
                                                  OpStore %138 %137 
                            Private f32* %140 = OpAccessChain %26 %119 
                                     f32 %141 = OpLoad %140 
                                     f32 %142 = OpLoad %89 
                                    bool %143 = OpFOrdLessThan %141 %142 
                                                  OpStore %139 %143 
                                    bool %144 = OpLoad %139 
                                                  OpSelectionMerge %148 None 
                                                  OpBranchConditional %144 %147 %150 
                                         %147 = OpLabel 
                                   f32_3 %149 = OpLoad %61 
                                                  OpStore %146 %149 
                                                  OpBranch %148 
