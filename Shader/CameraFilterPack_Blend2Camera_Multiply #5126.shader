...
; Schema: 0
                                           ...
                                           %1 = OpExtInstImport "GLSL.std.450" 
                                                  OpMemoryModel Logical GLSL450 
                                                  OpEntryPoint Fragment %4 "main" %28 %124 
               ...
               read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                            ...
                            Uniform f32* %106 = OpAccessChain %14 %90 
                                   ...
                                   f32_3 %122 = OpFAdd %119 %121 
                                                  OpStore %26 %122 
                            Uniform f32* %126 = OpAccessChain %14 %125 
                                     f32 %127 = OpLoad %126 
                            Uniform f32* %128 = OpAccessChain %14 %125 
                                     f32 %129 = OpLoad %128 
                            Uniform f32* %130 = OpAccessChain %14 %125 
                                     f32 %131 = OpLoad %130 
                                   f32_3 %132 = OpCompositeConstruct %127 %129 %131 
                                     f32 %133 = OpCompositeExtract %132 0 
                                     f32 %134 = OpCompositeExtract %132 1 
                                     f32 %135 = OpCompositeExtract %132 2 
                                   f32_3 %136 = OpCompositeConstruct %133 %134 %135 
                                   f32_3 %137 = OpLoad %26 
                                   ...
                                   f32_4 %142 = OpVectorShuffle %141 %140 4 5 6 3 
                                                  OpStore %124 %142 
                             Output f32* %145 = OpAccessChain %124 %143 
                                                  OpStore %145 %47 
                                                  OpReturn
                                                  OpFunctionEnd
"
