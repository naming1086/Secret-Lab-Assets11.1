...
void main()
{
    ...
    u_xlat3.xyz = u_xlat1.xyz + (-_ColorKey.xyz);
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %28 %156 
         ...
         UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                   ...
                   read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                                        ...
                                        f32_3 %84 = OpVectorShuffle %83 %83 0 1 2 
                                                      OpStore %26 %84 
                                        f32_3 %86 = OpLoad %61 
                               Uniform f32_4* %88 = OpAccessChain %14 %87 
                                        f32_4 %89 = OpLoad %88 
                                        f32_3 %90 = OpVectorShuffle %89 %89 0 1 2 
                                        f32_3 %91 = OpFNegate %90 
                                        f32_3 %92 = OpFAdd %86 %91 
                                                      OpStore %85 %92 
                                        f32_3 %93 = OpLoad %85 
                                        f32_3 %94 = OpCompositeConstruct %22 %22 %22 
                                        f32_3 %95 = OpCompositeConstruct %47 %47 %47 
                                        f32_3 %96 = OpExtInst %1 43 %93 %94 %95 
                                                      OpStore %85 %96 
                                        f32_3 %97 = OpLoad %61 
                                 Uniform f32* %99 = OpAccessChain %14 %98 
                                         f32 %100 = OpLoad %99 
                                Uniform f32* %102 = OpAccessChain %14 %101 
                                         f32 %103 = OpLoad %102 
                                Uniform f32* %105 = OpAccessChain %14 %104 
                                         f32 %106 = OpLoad %105 
                                       f32_3 %107 = OpCompositeConstruct %100 %103 %106 
                                       f32_3 %108 = OpFAdd %97 %107 
                                                      OpStore %61 %108 
                                       f32_3 %109 = OpLoad %26 
                                       ...
                                       f32_3 %112 = OpFAdd %110 %111 
                                                      OpStore %61 %112 
                                Private f32* %114 = OpAccessChain %85 %18 
                                         f32 %115 = OpLoad %114 
                                Private f32* %117 = OpAccessChain %85 %116 
                                         f32 %118 = OpLoad %117 
                                         f32 %119 = OpFAdd %115 %118 
                                                      OpStore %113 %119 
                                Private f32* %120 = OpAccessChain %85 %59 
                                         f32 %121 = OpLoad %120 
                                         f32 %122 = OpLoad %113 
                                ...
                                Uniform f32* %129 = OpAccessChain %14 %128 
                                         ...
                                         f32 %137 = OpFMul %135 %136 
                                                      OpStore %113 %137 
                                         f32 %138 = OpLoad %113 
                                         f32 %139 = OpExtInst %1 43 %138 %22 %47 
                                                      OpStore %113 %139 
                                         f32 %140 = OpLoad %113 
                                ...
                                Uniform f32* %158 = OpAccessChain %14 %157 
                                         f32 %159 = OpLoad %158 
                                Uniform f32* %160 = OpAccessChain %14 %157 
                                         f32 %161 = OpLoad %160 
                                Uniform f32* %162 = OpAccessChain %14 %157 
                                         f32 %163 = OpLoad %162 
                                       f32_3 %164 = OpCompositeConstruct %159 %161 %163 
                                         f32 %165 = OpCompositeExtract %164 0 
                                         f32 %166 = OpCompositeExtract %164 1 
                                         f32 %167 = OpCompositeExtract %164 2 
                                       f32_3 %168 = OpCompositeConstruct %165 %166 %167 
                                       f32_3 %169 = OpLoad %61 
                                       f32_3 %170 = OpFMul %168 %169 
                                       f32_3 %171 = OpLoad %26 
                                       f32_3 %172 = OpFAdd %170 %171 
                                       f32_4 %173 = OpLoad %156 
                                       f32_4 %174 = OpVectorShuffle %173 %172 4 5 6 3 
                                                      OpStore %156 %174 
                                 Output f32* %177 = OpAccessChain %156 %175 
                                                      OpStore %177 %47 
                                                      OpReturn
                                                      OpFunctionEnd
"
