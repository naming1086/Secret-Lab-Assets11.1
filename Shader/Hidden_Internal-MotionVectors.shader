...
; Schema: 0
                        ...
                        %1 = OpExtInstImport "GLSL.std.450" 
                               OpMemoryModel Logical GLSL450 
                               OpEntryPoint Fragment %4 "main" %11 %46 %95 
 ...
 Input f32_4* vs_TEXCOORD0 = OpVariable Input 
                 ...
                 f32_2 %23 = OpConstantComposite %22 %22 
                       %27 = OpTypeInt 32 0 
                   u32 %28 = OpConstant 0 
...
Uniform struct {i32;}* %81 = OpVariable Uniform 
         ...
         Output f32_4* %95 = OpVariable Output 
          ...
          Private f32* %42 = OpAccessChain %9 %41 
                 ...
                 f32_4 %49 = OpLoad vs_TEXCOORD1 
                 f32_2 %50 = OpVectorShuffle %49 %49 3 3 
                 f32_2 %51 = OpFDiv %48 %50 
                 f32_3 %52 = OpLoad %45 
                 f32_3 %53 = OpVectorShuffle %52 %51 3 1 4 
                               OpStore %45 %53 
                 f32_3 %54 = OpLoad %45 
                 f32_2 %55 = OpVectorShuffle %54 %54 0 2 
                 f32_2 %56 = OpFAdd %55 %23 
                 f32_3 %57 = OpLoad %45 
                 f32_3 %58 = OpVectorShuffle %57 %56 3 1 4 
                               OpStore %45 %58 
          Private f32* %60 = OpAccessChain %45 %28 
                   f32 %61 = OpLoad %60 
                   f32 %62 = OpFMul %61 %32 
          Private f32* %63 = OpAccessChain %59 %28 
                               OpStore %63 %62 
          Private f32* %64 = OpAccessChain %45 %41 
                   f32 %65 = OpLoad %64 
                   f32 %66 = OpFNegate %65 
                   f32 %67 = OpFMul %66 %32 
                   f32 %68 = OpFAdd %67 %22 
          Private f32* %69 = OpAccessChain %59 %41 
                               OpStore %69 %68 
                 f32_4 %70 = OpLoad %9 
          ...
          Uniform i32* %84 = OpAccessChain %81 %82 
                  ...
                  bool %87 = OpINotEqual %85 %82 
                   f32 %89 = OpSelect %87 %22 %88 
          Private f32* %90 = OpAccessChain %59 %28 
                               OpStore %90 %89 
          Private f32* %91 = OpAccessChain %9 %41 
                               OpStore %91 %88 
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %22 %63 %231 
                                                      OpExecutionMode %4 OriginUpperLeft 
                                                      OpName vs_TEXCOORD0 "vs_TEXCOORD0" 
                                                      OpName vs_TEXCOORD1 "vs_TEXCOORD1" 
                        ...
                        Input f32_3* vs_TEXCOORD1 = OpVariable Input 
                              ...
                              Private f32_3* %172 = OpVariable Private 
                               ...
                               Output f32_4* %231 = OpVariable Output 
                                       ...
                                       f32_2 %241 = OpConstantComposite %240 %50 
                                          void %4 = OpFunction None %3 
                                               %5 = OpLabel 
                   ...
                   read_only Texture2DSampled %19 = OpSampledImage %13 %17 
                              ...
                              Uniform f32_4* %197 = OpAccessChain %36 %102 %102 
                                ...
                                Private f32* %229 = OpAccessChain %9 %59 
                                                      OpStore %229 %228 
                                       f32_4 %232 = OpLoad %79 
                                       f32_2 %233 = OpVectorShuffle %232 %232 0 2 
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %26 %53 %69 %234 
                                                      OpExecutionMode %4 OriginUpperLeft 
                        ...
                        Input f32_2* vs_TEXCOORD0 = OpVariable Input 
                              ...
                              Private f32_3* %175 = OpVariable Private 
                               ...
                               Output f32_4* %234 = OpVariable Output 
                                       ...
                                       f32_2 %244 = OpConstantComposite %243 %71 
                                          void %4 = OpFunction None %3 
                                               %5 = OpLabel 
