...
void main()
{
    ...
    u_xlat9 = max(u_xlat1.z, u_xlat1.x);
    u_xlat10 = u_xlat9 * 0.800000012;
    u_xlat9 = (-u_xlat9) + u_xlat1.y;
    u_xlat9 = u_xlat9 + (-_Value3);
    u_xlat9 = u_xlat9 * 3.0;
    u_xlat9 = clamp(u_xlat9, 0.0, 1.0);
    u_xlat2.x = u_xlat1.y + (-_Value2);
    u_xlat2.y = min(u_xlat10, u_xlat2.x);
    u_xlat4 = u_xlat1.y + (-u_xlat2.y);
    u_xlat2.xz = u_xlat1.xz;
...
; Schema: 0
                                               ...
                                               %1 = OpExtInstImport "GLSL.std.450" 
                                                      OpMemoryModel Logical GLSL450 
                                                      OpEntryPoint Fragment %4 "main" %28 %174 
         ...
         UniformConstant read_only Texture2D* %76 = OpVariable UniformConstant 
                     UniformConstant sampler* %78 = OpVariable UniformConstant 
                              ...
                              Private f32_3* %100 = OpVariable Private 
                                         ...
                                         i32 %154 = OpConstant 5 
                                             %173 = OpTypePointer Output %11 
                               Output f32_4* %174 = OpVariable Output 
                                         i32 %175 = OpConstant 0 
                                         u32 %193 = OpConstant 3 
                                             %194 = OpTypePointer Output %9 
                                          void %4 = OpFunction None %3 
                                               %5 = OpLabel 
                   ...
                   read_only Texture2DSampled %80 = OpSampledImage %77 %79 
                                        ...
                                        f32_3 %84 = OpVectorShuffle %83 %83 0 1 2 
                                                      OpStore %26 %84 
                                 Private f32* %86 = OpAccessChain %61 %18 
                                          f32 %87 = OpLoad %86 
                                 Uniform f32* %89 = OpAccessChain %14 %88 
                                          f32 %90 = OpLoad %89 
                                          f32 %91 = OpFNegate %90 
                                          f32 %92 = OpFAdd %87 %91 
                                                      OpStore %85 %92 
                                 Private f32* %94 = OpAccessChain %61 %59 
                                          f32 %95 = OpLoad %94 
                                 Private f32* %97 = OpAccessChain %61 %96 
                                          f32 %98 = OpLoad %97 
                                          f32 %99 = OpExtInst %1 40 %95 %98 
                                                      OpStore %93 %99 
                                         f32 %101 = OpLoad %93 
                                         f32 %103 = OpFMul %101 %102 
                                Private f32* %104 = OpAccessChain %100 %96 
                                                      OpStore %104 %103 
                                Private f32* %105 = OpAccessChain %61 %18 
                                         ...
                                         f32 %109 = OpFAdd %106 %108 
                                                      OpStore %93 %109 
                                         f32 %110 = OpLoad %93 
                                Uniform f32* %112 = OpAccessChain %14 %111 
                                         f32 %113 = OpLoad %112 
                                         ...
                                         f32 %118 = OpFMul %116 %117 
                                                      OpStore %93 %118 
                                         f32 %119 = OpLoad %93 
                                         f32 %120 = OpExtInst %1 43 %119 %22 %47 
                                                      OpStore %93 %120 
                                         f32 %121 = OpLoad %85 
                                Private f32* %122 = OpAccessChain %100 %96 
                                         f32 %123 = OpLoad %122 
                                         f32 %124 = OpExtInst %1 37 %121 %123 
                                Private f32* %125 = OpAccessChain %100 %18 
                                                      OpStore %125 %124 
                                Private f32* %126 = OpAccessChain %61 %18 
                                         f32 %127 = OpLoad %126 
                                Private f32* %128 = OpAccessChain %100 %18 
                                         f32 %129 = OpLoad %128 
                                       ...
                                       f32_3 %135 = OpVectorShuffle %134 %133 3 1 4 
                                                      OpStore %100 %135 
                                         f32 %136 = OpLoad %43 
                                Uniform f32* %138 = OpAccessChain %14 %137 
                                         f32 %139 = OpLoad %138 
                                         f32 %140 = OpFNegate %139 
                                         f32 %141 = OpFAdd %136 %140 
                                Private f32* %142 = OpAccessChain %61 %96 
                                                      OpStore %142 %141 
                                       f32_3 %143 = OpLoad %61 
                                       ...
                                       f32_3 %146 = OpFAdd %144 %145 
                                                      OpStore %61 %146 
                                       f32_3 %147 = OpLoad %61 
                                Uniform f32* %149 = OpAccessChain %14 %148 
                                         f32 %150 = OpLoad %149 
                                Uniform f32* %152 = OpAccessChain %14 %151 
                                         f32 %153 = OpLoad %152 
                                Uniform f32* %155 = OpAccessChain %14 %154 
                                         f32 %156 = OpLoad %155 
                                       f32_3 %157 = OpCompositeConstruct %150 %153 %156 
                                       f32_3 %158 = OpFAdd %147 %157 
                                                      OpStore %61 %158 
                                       f32_3 %159 = OpLoad %61 
                                       ...
                                       f32_3 %172 = OpFAdd %170 %171 
                                                      OpStore %61 %172 
                                Uniform f32* %176 = OpAccessChain %14 %175 
                                         f32 %177 = OpLoad %176 
                                Uniform f32* %178 = OpAccessChain %14 %175 
                                         f32 %179 = OpLoad %178 
                                Uniform f32* %180 = OpAccessChain %14 %175 
                                         f32 %181 = OpLoad %180 
                                       f32_3 %182 = OpCompositeConstruct %177 %179 %181 
                                         f32 %183 = OpCompositeExtract %182 0 
                                         f32 %184 = OpCompositeExtract %182 1 
                                         f32 %185 = OpCompositeExtract %182 2 
                                       f32_3 %186 = OpCompositeConstruct %183 %184 %185 
                                       f32_3 %187 = OpLoad %61 
