...
; Schema: 0
                                      ...
                                      %1 = OpExtInstImport "GLSL.std.450" 
                                             OpMemoryModel Logical GLSL450 
                                             OpEntryPoint Fragment %4 "main" %12 %115 
...
UniformConstant read_only Texture2D* %33 = OpVariable UniformConstant 
          ...
          read_only Texture2DSampled %40 = OpSampledImage %34 %38 
                        ...
                        Private f32* %75 = OpAccessChain %53 %60 
                                             OpStore %75 %74 
                                 f32 %77 = OpLoad %46 
                               f32_2 %78 = OpCompositeConstruct %77 %77 
                               f32_2 %82 = OpFMul %78 %81 
                               f32_2 %86 = OpFAdd %82 %85 
                               f32_3 %87 = OpLoad %76 
                               f32_3 %88 = OpVectorShuffle %87 %86 3 1 4 
                                             OpStore %76 %88 
                               f32_3 %89 = OpLoad %76 
                               f32_2 %90 = OpVectorShuffle %89 %89 0 2 
                               f32_2 %92 = OpCompositeConstruct %91 %91 
                               f32_2 %93 = OpCompositeConstruct %57 %57 
                               f32_2 %94 = OpExtInst %1 43 %90 %92 %93 
                               f32_3 %95 = OpLoad %76 
                        ...
                        Private f32* %97 = OpAccessChain %53 %60 
                                ...
                                f32 %100 = OpFMul %99 %84 
                                             OpStore %46 %100 
                                f32 %101 = OpLoad %46 
                                f32 %102 = OpLoad %46 
                                f32 %103 = OpFMul %101 %102 
                       Private f32* %105 = OpAccessChain %76 %104 
                                             OpStore %105 %103 
                       Private f32* %106 = OpAccessChain %76 %104 
                                f32 %107 = OpLoad %106 
                                f32 %108 = OpExtInst %1 43 %107 %91 %57 
                       Private f32* %109 = OpAccessChain %76 %104 
                                             OpStore %109 %108 
                              f32_3 %110 = OpLoad %9 
                       ...
                       Uniform f32* %117 = OpAccessChain %17 %116 
                                f32 %118 = OpLoad %117 
                       Uniform f32* %119 = OpAccessChain %17 %116 
                                f32 %120 = OpLoad %119 
                       Uniform f32* %121 = OpAccessChain %17 %116 
                                f32 %122 = OpLoad %121 
                              f32_3 %123 = OpCompositeConstruct %118 %120 %122 
                                f32 %124 = OpCompositeExtract %123 0 
                                f32 %125 = OpCompositeExtract %123 1 
                                f32 %126 = OpCompositeExtract %123 2 
                              f32_3 %127 = OpCompositeConstruct %124 %125 %126 
                              f32_3 %128 = OpLoad %53 
                              ...
                              f32_4 %133 = OpVectorShuffle %132 %131 4 5 6 3 
                                             OpStore %115 %133 
                        Output f32* %136 = OpAccessChain %115 %134 
                                             OpStore %136 %57 
                                             OpReturn
                                             OpFunctionEnd
"
